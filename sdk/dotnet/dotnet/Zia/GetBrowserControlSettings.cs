...
namespace zscaler.PulumiPackage.Zia
{
    public static class GetBrowserControlSettings
    {
        ...
        /// ```
        /// </summary>
        public static Task<GetBrowserControlSettingsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBrowserControlSettingsResult>("zia:index/getBrowserControlSettings:getBrowserControlSettings", InvokeArgs.Empty, options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<GetBrowserControlSettingsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBrowserControlSettingsResult>("zia:index/getBrowserControlSettings:getBrowserControlSettings", InvokeArgs.Empty, options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<GetBrowserControlSettingsResult> Invoke(InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetBrowserControlSettingsResult>("zia:index/getBrowserControlSettings:getBrowserControlSettings", InvokeArgs.Empty, options.WithDefaults());
    }


    [OutputType]
    public sealed class GetBrowserControlSettingsResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetBrowserControlSettingsSmartIsolationProfileResult> SmartIsolationProfiles;

        [OutputConstructor]
        private GetBrowserControlSettingsResult(
            ...
            ImmutableArray<Outputs.GetBrowserControlSettingsSmartIsolationProfileResult> smartIsolationProfiles)
        {
