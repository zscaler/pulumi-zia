...
namespace zscaler.PulumiPackage.Zia
{
    ...
    /// ```
    /// </summary>
    [ZiaResourceType("zia:index:FirewallIPSRule")]
    public partial class FirewallIPSRule : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<int>> ThreatCategories { get; private set; } = null!;
        ...
        public FirewallIPSRule(string name, FirewallIPSRuleArgs args, CustomResourceOptions? options = null)
            : base("zia:index:FirewallIPSRule", name, args ?? new FirewallIPSRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallIPSRule(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("zia:index:FirewallIPSRule", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallIPSRule Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
    ...
    public sealed class FirewallIPSRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<int>? _threatCategories;

        /// <summary>
        /// IDs of threat categories to which the rule applies.
        /// </summary>
        public InputList<int> ThreatCategories
        {
            get => _threatCategories ?? (_threatCategories = new InputList<int>());
            set => _threatCategories = value;
        }
