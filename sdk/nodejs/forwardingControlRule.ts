...
export class ForwardingControlRule extends pulumi.CustomResource {
     ...
     */
    public readonly appServiceGroups!: pulumi.Output<outputs.ForwardingControlRuleAppServiceGroups>;
    /**
     * (list) Apply to any number of departments When not used it implies `Any` to apply the rule to all departments.
     */
    public readonly departments!: pulumi.Output<outputs.ForwardingControlRuleDepartments>;
    /**
     ...
     */
    public readonly destIpGroups!: pulumi.Output<outputs.ForwardingControlRuleDestIpGroups>;
    /**
     ...
     */
    public readonly destIpv6Groups!: pulumi.Output<outputs.ForwardingControlRuleDestIpv6Groups>;
    /**
     ...
     */
    public readonly groups!: pulumi.Output<outputs.ForwardingControlRuleGroups>;
    /**
     * (list) Labels that are applicable to the rule.
     */
    public readonly labels!: pulumi.Output<outputs.ForwardingControlRuleLabels>;
    /**
     ...
     */
    public readonly locationGroups!: pulumi.Output<outputs.ForwardingControlRuleLocationGroups>;
    /**
     ...
     */
    public readonly nwApplicationGroups!: pulumi.Output<outputs.ForwardingControlRuleNwApplicationGroups>;
    /**
     * (list) Any number of predefined or custom network service groups to which the rule applies.
     */
    public readonly nwServiceGroups!: pulumi.Output<outputs.ForwardingControlRuleNwServiceGroups>;
    /**
     ...
     */
    public readonly srcIpGroups!: pulumi.Output<outputs.ForwardingControlRuleSrcIpGroups>;
    /**
     ...
     */
    public readonly srcIpv6Groups!: pulumi.Output<outputs.ForwardingControlRuleSrcIpv6Groups>;
    /**
     ...
     */
    public readonly users!: pulumi.Output<outputs.ForwardingControlRuleUsers>;
    /**
     ...
     */
    public readonly zpaApplicationSegmentGroups!: pulumi.Output<outputs.ForwardingControlRuleZpaApplicationSegmentGroups>;
    /**
     ...
     */
    public readonly zpaApplicationSegments!: pulumi.Output<outputs.ForwardingControlRuleZpaApplicationSegments>;
    /**
