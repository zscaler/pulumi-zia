 ...
 * ## Example Usage
 */
export function getAdminUsersOutput(args?: GetAdminUsersOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAdminUsersResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zia:index/getAdminUsers:getAdminUsers", {
        "id": args.id,
        "loginName": args.loginName,
        "username": args.username,
    }, opts);
