 ...
 * ## Example Usage
 */
export function getForwardingProxyGateway(args?: GetForwardingProxyGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetForwardingProxyGatewayResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("zia:index/getForwardingProxyGateway:getForwardingProxyGateway", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
 ...
 */
export interface GetForwardingProxyGatewayArgs {
    /**
 ...
 */
export interface GetForwardingProxyGatewayResult {
    /**
     ...
     */
    readonly lastModifiedBies: outputs.GetForwardingProxyGatewayLastModifiedBy[];
    /**
     ...
     */
    readonly primaryProxies: outputs.GetForwardingProxyGatewayPrimaryProxy[];
    /**
     * () - The secondary proxy for the gateway. This field is not applicable to the Lite API.
     */
    readonly secondaryProxies: outputs.GetForwardingProxyGatewaySecondaryProxy[];
    /**
 ...
 * ## Example Usage
 */
export function getForwardingProxyGatewayOutput(args?: GetForwardingProxyGatewayOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetForwardingProxyGatewayResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zia:index/getForwardingProxyGateway:getForwardingProxyGateway", {
        "id": args.id,
        "name": args.name,
    }, opts);
}
 ...
 * A collection of arguments for invoking getForwardingProxyGateway.
 */
export interface GetForwardingProxyGatewayOutputArgs {
    /**
     * The ID of the forwarding control Proxy Gateway resource.
     */
