...
export class BrowserControlPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'zia:index/browserControlPolicy:BrowserControlPolicy';
     ...
     */
    declare public readonly smartIsolationGroups: pulumi.Output<outputs.BrowserControlPolicySmartIsolationGroups | undefined>;
    /**
     * The isolation profile
     */
    declare public readonly smartIsolationProfiles: pulumi.Output<outputs.BrowserControlPolicySmartIsolationProfile[]>;
    /**
     * Name-ID pairs of users for which the rule is applied
     */
    declare public readonly smartIsolationUsers: pulumi.Output<outputs.BrowserControlPolicySmartIsolationUsers | undefined>;
    ...
    constructor(name: string, argsOrState?: BrowserControlPolicyArgs | BrowserControlPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as BrowserControlPolicyState | undefined;
            ...
            const args = argsOrState as BrowserControlPolicyArgs | undefined;
 ...
 */
export interface BrowserControlPolicyState {
    /**
     * A Boolean value that specifies whether or not to allow all the browsers and their respective versions access to the internet
     */
     ...
     * Name-ID pairs of groups for which the rule is applied
     */
    smartIsolationGroups?: pulumi.Input<inputs.BrowserControlPolicySmartIsolationGroups>;
    /**
     * The isolation profile
     */
    smartIsolationProfiles?: pulumi.Input<pulumi.Input<inputs.BrowserControlPolicySmartIsolationProfile>[]>;
    /**
     * Name-ID pairs of users for which the rule is applied
     */
    smartIsolationUsers?: pulumi.Input<inputs.BrowserControlPolicySmartIsolationUsers>;
}
