...
export class BrowserControlPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly smartIsolationGroups!: pulumi.Output<outputs.BrowserControlPolicySmartIsolationGroups | undefined>;
    /**
     * The isolation profile
     */
    public readonly smartIsolationProfiles!: pulumi.Output<outputs.BrowserControlPolicySmartIsolationProfile[]>;
    /**
     * Name-ID pairs of users for which the rule is applied
     */
    public readonly smartIsolationUsers!: pulumi.Output<outputs.BrowserControlPolicySmartIsolationUsers | undefined>;
