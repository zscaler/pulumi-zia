 ...
 * ## Example Usage
 */
export function getTrafficForwardingNodeVIPsOutput(args?: GetTrafficForwardingNodeVIPsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTrafficForwardingNodeVIPsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zia:index/getTrafficForwardingNodeVIPs:getTrafficForwardingNodeVIPs", {
        "datacenter": args.datacenter,
    }, opts);
}
