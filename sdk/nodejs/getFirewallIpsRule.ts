...
export function getFirewallIpsRule(args?: GetFirewallIpsRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallIpsRuleResult> {
    pulumi.log.warn("getFirewallIpsRule is deprecated: zia.index/getfirewallipsrule.getFirewallIpsRule has been deprecated in favor of zia.index/getipsfirewallrule.getIPSFirewallRule")
    args = args || {};
