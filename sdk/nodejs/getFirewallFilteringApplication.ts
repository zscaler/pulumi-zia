 ...
 * ## Example Usage
 */
export function getFirewallFilteringApplicationOutput(args?: GetFirewallFilteringApplicationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFirewallFilteringApplicationResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zia:index/getFirewallFilteringApplication:getFirewallFilteringApplication", {
        "id": args.id,
        "locale": args.locale,
    }, opts);
}
