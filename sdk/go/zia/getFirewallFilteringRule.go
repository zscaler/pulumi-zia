...
func LookupFirewallFilteringRuleOutput(ctx *pulumi.Context, args LookupFirewallFilteringRuleOutputArgs, opts ...pulumi.InvokeOption) LookupFirewallFilteringRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupFirewallFilteringRuleResultOutput, error) {
			args := v.(LookupFirewallFilteringRuleArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("zia:index/getFirewallFilteringRule:getFirewallFilteringRule", args, LookupFirewallFilteringRuleResultOutput{}, options).(LookupFirewallFilteringRuleResultOutput), nil
