...
func LookupLocationManagementOutput(ctx *pulumi.Context, args LookupLocationManagementOutputArgs, opts ...pulumi.InvokeOption) LookupLocationManagementResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupLocationManagementResultOutput, error) {
			args := v.(LookupLocationManagementArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("zia:index/getLocationManagement:getLocationManagement", args, LookupLocationManagementResultOutput{}, options).(LookupLocationManagementResultOutput), nil
...
// (List of String) IP ports that are associated with the location.
func (o LookupLocationManagementResultOutput) Ports() pulumi.StringArrayOutput {
	return o.ApplyT(func(v LookupLocationManagementResult) []string { return v.Ports }).(pulumi.StringArrayOutput)
}
