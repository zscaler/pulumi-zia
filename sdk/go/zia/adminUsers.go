...
type AdminUsers struct {
	...
	AdminScopeEntities AdminUsersAdminScopeEntitiesPtrOutput `pulumi:"adminScopeEntities"`
...
// list of destination ip groups
func (o AdminUsersOutput) AdminScopeEntities() AdminUsersAdminScopeEntitiesPtrOutput {
	return o.ApplyT(func(v *AdminUsers) AdminUsersAdminScopeEntitiesPtrOutput { return v.AdminScopeEntities }).(AdminUsersAdminScopeEntitiesPtrOutput)
}
