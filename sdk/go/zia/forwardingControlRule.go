...
type ForwardingControlRule struct {
	...
	AppServiceGroups ForwardingControlRuleAppServiceGroupsOutput `pulumi:"appServiceGroups"`
	// (list) Apply to any number of departments When not used it implies `Any` to apply the rule to all departments.
	Departments ForwardingControlRuleDepartmentsOutput `pulumi:"departments"`
	...
	DestIpGroups ForwardingControlRuleDestIpGroupsOutput `pulumi:"destIpGroups"`
	...
	Labels ForwardingControlRuleLabelsOutput `pulumi:"labels"`
	...
	SrcIpGroups ForwardingControlRuleSrcIpGroupsOutput `pulumi:"srcIpGroups"`
	...
	ZpaApplicationSegmentGroups ForwardingControlRuleZpaApplicationSegmentGroupsOutput `pulumi:"zpaApplicationSegmentGroups"`
	...
	ZpaApplicationSegments ForwardingControlRuleZpaApplicationSegmentsOutput `pulumi:"zpaApplicationSegments"`
...
// (list) - Application service groups on which this rule is applied
func (o ForwardingControlRuleOutput) AppServiceGroups() ForwardingControlRuleAppServiceGroupsOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleAppServiceGroupsOutput { return v.AppServiceGroups }).(ForwardingControlRuleAppServiceGroupsOutput)
}

// (list) Apply to any number of departments When not used it implies `Any` to apply the rule to all departments.
func (o ForwardingControlRuleOutput) Departments() ForwardingControlRuleDepartmentsOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleDepartmentsOutput { return v.Departments }).(ForwardingControlRuleDepartmentsOutput)
}
...
// ** - (list) Any number of destination IP address groups that you want to control with this rule.
func (o ForwardingControlRuleOutput) DestIpGroups() ForwardingControlRuleDestIpGroupsOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleDestIpGroupsOutput { return v.DestIpGroups }).(ForwardingControlRuleDestIpGroupsOutput)
}

// ** - (list) Destination IPv6 address groups for which the rule is applicable. If not set, the rule is not restricted to a specific source IPv6 address group.
func (o ForwardingControlRuleOutput) DestIpv6Groups() ForwardingControlRuleDestIpv6GroupsOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleDestIpv6GroupsOutput { return v.DestIpv6Groups }).(ForwardingControlRuleDestIpv6GroupsOutput)
}

// (list) - Name-ID pairs of the Zscaler Cloud Connector groups to which the forwarding rule applies
func (o ForwardingControlRuleOutput) EcGroups() ForwardingControlRuleEcGroupsOutput {
...
// (list) You can manually select up to `8` groups. When not used it implies `Any` to apply the rule to all groups.
func (o ForwardingControlRuleOutput) Groups() ForwardingControlRuleGroupsOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleGroupsOutput { return v.Groups }).(ForwardingControlRuleGroupsOutput)
}

// (list) Labels that are applicable to the rule.
func (o ForwardingControlRuleOutput) Labels() ForwardingControlRuleLabelsOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleLabelsOutput { return v.Labels }).(ForwardingControlRuleLabelsOutput)
}

// (Optional) You can manually select up to `32` location groups. When not used it implies `Any` to apply the rule to all location groups.
func (o ForwardingControlRuleOutput) LocationGroups() ForwardingControlRuleLocationGroupsOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleLocationGroupsOutput { return v.LocationGroups }).(ForwardingControlRuleLocationGroupsOutput)
}

// (Optional) You can manually select up to `8` locations. When not used it implies `Any` to apply the rule to all groups.
func (o ForwardingControlRuleOutput) Locations() ForwardingControlRuleLocationsOutput {
...
// (list) Any number of application groups that you want to control with this rule. The service provides predefined applications that you can group, but not modify
func (o ForwardingControlRuleOutput) NwApplicationGroups() ForwardingControlRuleNwApplicationGroupsOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleNwApplicationGroupsOutput {
		return v.NwApplicationGroups
	}).(ForwardingControlRuleNwApplicationGroupsOutput)
}

// (list) Any number of predefined or custom network service groups to which the rule applies.
func (o ForwardingControlRuleOutput) NwServiceGroups() ForwardingControlRuleNwServiceGroupsOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleNwServiceGroupsOutput { return v.NwServiceGroups }).(ForwardingControlRuleNwServiceGroupsOutput)
}

// (list) When not used it applies the rule to all network services or you can select specific network services. The Zscaler firewall has predefined services and you can configure up to `1,024` additional custom services.
func (o ForwardingControlRuleOutput) NwServices() ForwardingControlRuleNwServicesOutput {
...
// (list) Any number of source IP address groups that you want to control with this rule.
func (o ForwardingControlRuleOutput) SrcIpGroups() ForwardingControlRuleSrcIpGroupsOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleSrcIpGroupsOutput { return v.SrcIpGroups }).(ForwardingControlRuleSrcIpGroupsOutput)
}
...
// (list) Source IPv6 address groups for which the rule is applicable. If not set, the rule is not restricted to a specific source IPv6 address group.
func (o ForwardingControlRuleOutput) SrcIpv6Groups() ForwardingControlRuleSrcIpv6GroupsOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleSrcIpv6GroupsOutput { return v.SrcIpv6Groups }).(ForwardingControlRuleSrcIpv6GroupsOutput)
}
...
// (list) You can manually select up to `4` general and/or special users. When not used it implies `Any` to apply the rule to all users.
func (o ForwardingControlRuleOutput) Users() ForwardingControlRuleUsersOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleUsersOutput { return v.Users }).(ForwardingControlRuleUsersOutput)
}
...
// (set) List of ZPA Application Segment Groups for which this rule is applicable. This field is applicable only for the `ECZPA` forwarding method (used for Zscaler Cloud Connector).
func (o ForwardingControlRuleOutput) ZpaApplicationSegmentGroups() ForwardingControlRuleZpaApplicationSegmentGroupsOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleZpaApplicationSegmentGroupsOutput {
		return v.ZpaApplicationSegmentGroups
	}).(ForwardingControlRuleZpaApplicationSegmentGroupsOutput)
}

// (set) List of ZPA Application Segments for which this rule is applicable. This field is applicable only for the `ECZPA` forwarding method (used for Zscaler Cloud Connector).
func (o ForwardingControlRuleOutput) ZpaApplicationSegments() ForwardingControlRuleZpaApplicationSegmentsOutput {
	return o.ApplyT(func(v *ForwardingControlRule) ForwardingControlRuleZpaApplicationSegmentsOutput {
		return v.ZpaApplicationSegments
	}).(ForwardingControlRuleZpaApplicationSegmentsOutput)
}
