...
func LookupForwardingControlRuleOutput(ctx *pulumi.Context, args LookupForwardingControlRuleOutputArgs, opts ...pulumi.InvokeOption) LookupForwardingControlRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupForwardingControlRuleResultOutput, error) {
			args := v.(LookupForwardingControlRuleArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("zia:index/getForwardingControlRule:getForwardingControlRule", args, LookupForwardingControlRuleResultOutput{}, options).(LookupForwardingControlRuleResultOutput), nil
