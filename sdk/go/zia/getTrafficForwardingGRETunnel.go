...
func LookupTrafficForwardingGRETunnelOutput(ctx *pulumi.Context, args LookupTrafficForwardingGRETunnelOutputArgs, opts ...pulumi.InvokeOption) LookupTrafficForwardingGRETunnelResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupTrafficForwardingGRETunnelResult, error) {
			args := v.(LookupTrafficForwardingGRETunnelArgs)
			r, err := LookupTrafficForwardingGRETunnel(ctx, &args, opts...)
			var s LookupTrafficForwardingGRETunnelResult
			if r != nil {
				s = *r
			}
			return s, err
