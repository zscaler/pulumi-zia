...
func LookupTrafficForwardingStaticIPOutput(ctx *pulumi.Context, args LookupTrafficForwardingStaticIPOutputArgs, opts ...pulumi.InvokeOption) LookupTrafficForwardingStaticIPResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTrafficForwardingStaticIPResultOutput, error) {
			args := v.(LookupTrafficForwardingStaticIPArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("zia:index/getTrafficForwardingStaticIP:getTrafficForwardingStaticIP", args, LookupTrafficForwardingStaticIPResultOutput{}, options).(LookupTrafficForwardingStaticIPResultOutput), nil
