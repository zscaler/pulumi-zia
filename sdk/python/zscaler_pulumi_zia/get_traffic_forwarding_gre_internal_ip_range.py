...
def get_traffic_forwarding_gre_internal_ip_range(required_count: Optional[_builtins.int] = None,
...
def get_traffic_forwarding_gre_internal_ip_range_output(required_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
