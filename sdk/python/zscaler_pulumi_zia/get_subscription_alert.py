...
class GetSubscriptionAlertResult:
    ...
    def comply_severities(self) -> Sequence[_builtins.str]:
        """
    ...
    def manage_severities(self) -> Sequence[_builtins.str]:
        """
    ...
    def pt0_severities(self) -> Sequence[_builtins.str]:
        """
    ...
    def secure_severities(self) -> Sequence[_builtins.str]:
        """
    ...
    def system_severities(self) -> Sequence[_builtins.str]:
        """
...
def get_subscription_alert(email: Optional[_builtins.str] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/alerts#/alertSubscriptions-get)
    ...
    :param _builtins.str email: The name of the subscription alert to be exported.
    :param _builtins.int id: The unique identifer for the subscription alert.
    """
    __args__ = dict()
...
def get_subscription_alert_output(email: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
