...
class GetFirewallDNSRulesResult:
    ...
    """
    def __init__(__self__, action=None, application_groups=None, applications=None, block_response_code=None, capture_pcap=None, default_dns_rule_name_used=None, default_rule=None, departments=None, description=None, dest_addresses=None, dest_countries=None, dest_ip_categories=None, dest_ip_groups=None, dest_ipv6_groups=None, device_groups=None, devices=None, dns_rule_request_types=None, groups=None, id=None, is_web_eun_enabled=None, labels=None, last_modified_bies=None, last_modified_time=None, location_groups=None, locations=None, name=None, order=None, predefined=None, protocols=None, rank=None, redirect_ip=None, res_categories=None, source_countries=None, src_ip_groups=None, src_ips=None, src_ipv6_groups=None, state=None, time_windows=None, users=None):
        ...
        if default_dns_rule_name_used and not isinstance(default_dns_rule_name_used, bool):
            raise TypeError("Expected argument 'default_dns_rule_name_used' to be a bool")
        ...
        if is_web_eun_enabled and not isinstance(is_web_eun_enabled, bool):
            raise TypeError("Expected argument 'is_web_eun_enabled' to be a bool")
    ...
    def block_response_code(self) -> _builtins.str:
        """
    ...
    def default_dns_rule_name_used(self) -> Optional[_builtins.bool]:
        """
    ...
    def dns_rule_request_types(self) -> Sequence[_builtins.str]:
        """
    ...
    def is_web_eun_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def redirect_ip(self) -> _builtins.str:
        """
...
class AwaitableGetFirewallDNSRulesResult(GetFirewallDNSRulesResult):
    ...
    def __await__(self):
        ...
        return GetFirewallDNSRulesResult(
            ...
            default_dns_rule_name_used=self.default_dns_rule_name_used,
            ...
            groups=self.groups,
            id=self.id,
            is_web_eun_enabled=self.is_web_eun_enabled,
            labels=self.labels,
...
def get_firewall_dns_rules(default_dns_rule_name_used: Optional[_builtins.bool] = None,
                           id: Optional[_builtins.int] = None,
                           is_web_eun_enabled: Optional[_builtins.bool] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/dns-control-policy#/firewallDnsRules-post)
    ...
    :param _builtins.bool default_dns_rule_name_used: (Boolean) A Boolean value that indicates whether the default DNS rule name is used for the rule.
    :param _builtins.int id: Unique identifier for the Firewall Filtering policy rule
    :param _builtins.bool is_web_eun_enabled: (Boolean) A Boolean value that indicates whether Enhanced User Notification (EUN) is enabled for the rule.
    :param _builtins.str name: Name of the Firewall Filtering policy rule
    """
    __args__ = dict()
    __args__['defaultDnsRuleNameUsed'] = default_dns_rule_name_used
    __args__['id'] = id
    __args__['isWebEunEnabled'] = is_web_eun_enabled
    __args__['name'] = name
    ...
    return AwaitableGetFirewallDNSRulesResult(
        ...
        default_dns_rule_name_used=pulumi.get(__ret__, 'default_dns_rule_name_used'),
        ...
        is_web_eun_enabled=pulumi.get(__ret__, 'is_web_eun_enabled'),
...
def get_firewall_dns_rules_output(default_dns_rule_name_used: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                  id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                  is_web_eun_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/dns-control-policy#/firewallDnsRules-post)
    ...
    return __ret__.apply(lambda __response__: GetFirewallDNSRulesResult(
        ...
        default_dns_rule_name_used=pulumi.get(__response__, 'default_dns_rule_name_used'),
        ...
        is_web_eun_enabled=pulumi.get(__response__, 'is_web_eun_enabled'),
