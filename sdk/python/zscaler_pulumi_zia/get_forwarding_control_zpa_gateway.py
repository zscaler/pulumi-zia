...
class GetForwardingControlZPAGatewayResult:
    ...
    def zpa_tenant_id(self) -> _builtins.int:
...
def get_forwarding_control_zpa_gateway(id: Optional[_builtins.int] = None,
...
def get_forwarding_control_zpa_gateway_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
