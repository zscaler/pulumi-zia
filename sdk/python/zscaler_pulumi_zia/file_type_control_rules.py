...
class FileTypeControlRulesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] order: The rule order of execution for the  File Type Control rule with respect to other rules.
        ...
        :param pulumi.Input[_builtins.bool] active_content: Flag to check whether a file has active content or not
        :param pulumi.Input[_builtins.bool] capture_pcap: A Boolean value that indicates whether packet capture (PCAP) is enabled or not
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] cloud_applications: The list of cloud applications to which the File Type Control rule must be applied
        ...
        :param pulumi.Input[_builtins.str] description: The description of the File Type Control rule.
        ...
        :param pulumi.Input[_builtins.str] filtering_action: Action taken when traffic matches policy. This field is not applicable to the Lite API.
        ...
        :param pulumi.Input[_builtins.int] max_size: Maximum file size (in KB) used for evaluation of the FTP rule
        :param pulumi.Input[_builtins.int] min_size: Minimum file size (in KB) used for evaluation of the FTP rule
        :param pulumi.Input[_builtins.str] name: The File Type Control policy rule name.
        :param pulumi.Input[_builtins.str] operation: File operation performed. This field is not applicable to the Lite API.
        :param pulumi.Input[_builtins.int] rank: Admin rank of the admin who creates this rule
        :param pulumi.Input[_builtins.str] state: Enables or disables the File Type Control rule.
        ...
        :param pulumi.Input[_builtins.bool] unscannable: Flag to check whether a file has active content or not
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] url_categories: The list of URL Categories to which the file type control rule rule must be applied.
...
class FileTypeControlRules(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="activeContent")
    def active_content(self) -> pulumi.Output[_builtins.bool]:
        """
        Flag to check whether a file has active content or not
        """
        return pulumi.get(self, "active_content")
    ...
    @_builtins.property
    @pulumi.getter(name="filteringAction")
    def filtering_action(self) -> pulumi.Output[_builtins.str]:
        """
        Action taken when traffic matches policy. This field is not applicable to the Lite API.
        """
        return pulumi.get(self, "filtering_action")
    ...
    @_builtins.property
    @pulumi.getter
    def unscannable(self) -> pulumi.Output[_builtins.bool]:
        """
        Flag to check whether a file has active content or not
        """
        return pulumi.get(self, "unscannable")
