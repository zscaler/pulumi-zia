...
class IPSFirewallRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] action: (String) The action configured for the rule that must take place if the traffic matches the rule criteria, such as allowing or blocking the traffic or bypassing the rule. The following actions are accepted: `ALLOW`, `BLOCK_DROP`, `BLOCK_RESET`, `BYPASS_IPS`
        ...
        :param pulumi.Input[_builtins.bool] default_rule: (Boolean) Value that indicates whether the rule is the Default Cloud IPS Rule or not
        ...
        :param pulumi.Input[_builtins.bool] enable_full_logging: (Integer) A Boolean value that indicates whether full logging is enabled. A true value indicates that full logging is enabled, whereas a false value indicates that aggregate logging is enabled.
        :param pulumi.Input[_builtins.int] eun_template_id: (Integer) The ID of the Enhanced User Notification (EUN) template associated with the rule.
        ...
        :param pulumi.Input[_builtins.bool] is_eun_enabled: (Boolean) A Boolean value that indicates whether Enhanced User Notification (EUN) is enabled for the rule.
        ...
        :param pulumi.Input[_builtins.str] name: The name of the IPS Control rule
