...
def get_devices(device_group_type: Optional[_builtins.str] = None,
                device_model: Optional[_builtins.str] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/device-groups#/deviceGroups-get)
    ...
    :param _builtins.str device_group_type: (String) The device group type. i.e ``ZCC_OS``, ``NON_ZCC``, ``CBI``
    :param _builtins.str device_model: (String) The device model.
    :param _builtins.int id: The unique identifer for the devices.
    :param _builtins.str name: The name of the devices to be exported.
    :param _builtins.str os_type: (String) The operating system (OS). ``ANY``, ``OTHER_OS``, ``IOS``, ``ANDROID_OS``, ``WINDOWS_OS``, ``MAC_OS``, ``LINUX``
    :param _builtins.str os_version: (String) The operating system version.
    :param _builtins.str owner_name: (String) The device owner's user name.
    """
    __args__ = dict()
...
def get_devices_output(device_group_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                       device_model: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
