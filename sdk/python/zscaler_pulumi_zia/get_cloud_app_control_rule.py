...
class GetCloudAppControlRuleResult:
    ...
    def browser_eun_template_id(self) -> _builtins.int:
        return pulumi.get(self, "browser_eun_template_id")

    @_builtins.property
    @pulumi.getter(name="cascadingEnabled")
    def cascading_enabled(self) -> _builtins.bool:
    ...
    def number_of_applications(self) -> _builtins.int:
    ...
    def size_quota(self) -> _builtins.int:
    ...
    def time_quota(self) -> _builtins.int:
    ...
    def user_agent_types(self) -> Sequence[_builtins.str]:
...
def get_cloud_app_control_rule(id: Optional[_builtins.int] = None,
...
def get_cloud_app_control_rule_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
