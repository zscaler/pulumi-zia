...
class GetAdminRolesResult:
    ...
    def admin_acct_access(self) -> _builtins.str:
        """
        (String)
        """
    ...
    def alerting_access(self) -> _builtins.str:
        return pulumi.get(self, "alerting_access")

    @_builtins.property
    @pulumi.getter(name="analysisAccess")
    def analysis_access(self) -> _builtins.str:
        """
        (String)
        """
    ...
    def dashboard_access(self) -> _builtins.str:
        """
    ...
    def is_auditor(self) -> _builtins.bool:
        """
    ...
    def is_non_editable(self) -> _builtins.bool:
        """
    ...
    def logs_limit(self) -> _builtins.str:
        """
    ...
    def policy_access(self) -> _builtins.str:
        """
    ...
    def report_access(self) -> _builtins.str:
        """
    ...
    def report_time_duration(self) -> _builtins.int:
    ...
    def username_access(self) -> _builtins.str:
        """
...
def get_admin_roles(id: Optional[_builtins.int] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/admin-role-management#/adminRoles-get)
    ...
    :param _builtins.int id: The ID of the admin role to be exported.
    :param _builtins.str name: The name of the Admin role to be exported.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_admin_roles_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
