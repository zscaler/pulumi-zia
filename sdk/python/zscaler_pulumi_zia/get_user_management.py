...
class GetUserManagementResult:
    ...
    def auth_methods(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def is_auditor(self) -> _builtins.str:
...
def get_user_management(auth_methods: Optional[Sequence[_builtins.str]] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/about-url-filteringhttps://help.zscaler.com/zia/user-management#/users-get)
    ...
    :param Sequence[_builtins.str] auth_methods: (String) Type of authentication method to be enabled. Supported values are: ``BASIC`` and ``DIGEST``
...
def get_user_management_output(auth_methods: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
