...
class GetForwardingControlRuleResult:
    ...
    def forward_method(self) -> _builtins.str:
        """
    ...
    def zpa_broker_rule(self) -> _builtins.bool:
...
def get_forwarding_control_rule(id: Optional[_builtins.int] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/forwarding-control-policy#/forwardingRules-get)
    ...
    :param _builtins.str type: (string) -  The rule type selected from the available options
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_forwarding_control_rule_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
