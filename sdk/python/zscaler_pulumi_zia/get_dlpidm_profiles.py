...
def get_dlpidm_profiles(profile_id: Optional[_builtins.int] = None,
...
def get_dlpidm_profiles_output(profile_id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
