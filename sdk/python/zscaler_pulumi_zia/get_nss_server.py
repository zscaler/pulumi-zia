...
class GetNssServerResult:
    ...
    def icap_svr_id(self) -> _builtins.int:
        """
...
def get_nss_server(id: Optional[_builtins.int] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/cloud-nanolog-streaming-service-nss#/nssServers-get)
    ...
    :param _builtins.int id: System-generated identifier of the NSS server based on the software platform
    :param _builtins.str name: The name of the nss server to be exported.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_nss_server_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
