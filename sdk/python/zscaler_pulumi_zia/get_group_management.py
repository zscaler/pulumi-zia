...
def get_group_management(id: Optional[_builtins.int] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/user-management#/groups-get)
    ...
    :param _builtins.int id: Unique identfier for the group.
...
def get_group_management_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
