...
__all__ = ['SecurityPolicySettingsArgs', 'SecurityPolicySettings']

@pulumi.input_type
class SecurityPolicySettingsArgs:
    def __init__(__self__, *,
                 blacklist_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
    ...
    def blacklist_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def whitelist_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "whitelist_urls", value)


@pulumi.type_token("zia:index:SecurityPolicySettings")
class SecurityPolicySettings(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SecurityPolicySettingsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SecurityPolicySettingsArgs.__new__(SecurityPolicySettingsArgs)

            __props__.__dict__["blacklist_urls"] = blacklist_urls
            __props__.__dict__["whitelist_urls"] = whitelist_urls
            __props__.__dict__["resource_id"] = None
        super(SecurityPolicySettings, __self__).__init__(
            'zia:index:SecurityPolicySettings',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SecurityPolicySettings':
        """
        ...
        __props__.__dict__["blacklist_urls"] = None
        __props__.__dict__["resource_id"] = None
        __props__.__dict__["whitelist_urls"] = None
        return SecurityPolicySettings(resource_name, opts=opts, __props__=__props__)
