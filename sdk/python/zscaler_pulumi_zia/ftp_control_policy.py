...
class FtpControlPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] ftp_enabled: Indicates whether to enable native FTP. When enabled, users can connect to native FTP sites and download files.
        :param pulumi.Input[_builtins.bool] ftp_over_http_enabled: Indicates whether to enable FTP over HTTP.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] url_categories: List of URL categories that allow FTP traffic.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] urls: Domains or URLs included for the FTP Control settings
        """
...
class FtpControlPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ftp_over_http_enabled: Optional[pulumi.Input[_builtins.bool]] = None,
            url_categories: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'FtpControlPolicy':
        """
