...
def get_firewall_filtering_rule(id: Optional[_builtins.int] = None,
...
def get_firewall_filtering_rule_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
