...
class GetTrafficForwardingGRETunnelInfoResult:
    ...
    def gre_enabled(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "gre_enabled")

    @_builtins.property
    @pulumi.getter(name="greRangePrimary")
    def gre_range_primary(self) -> _builtins.str:
        """
        (String)
        """
    ...
    def gre_range_secondary(self) -> _builtins.str:
        """
        (String)
        """
    ...
    def gre_tunnel_ip(self) -> _builtins.str:
        """
    ...
    def primary_gw(self) -> _builtins.str:
        """
        (String)
        """
    ...
    def secondary_gw(self) -> _builtins.str:
        """
        (String)
        """
...
def get_traffic_forwarding_gre_tunnel_info(gre_enabled: Optional[_builtins.bool] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/traffic-forwarding-0#/orgProvisioning/ipGreTunnelInfo-get)
    ...
    :param _builtins.bool gre_enabled: Displays only ip addresses with GRE tunnel enabled
...
def get_traffic_forwarding_gre_tunnel_info_output(gre_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
