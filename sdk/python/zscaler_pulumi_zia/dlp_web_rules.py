...
class DLPWebRulesArgs:
    def __init__(__self__, *,
                 ...
                 file_type_categories: Optional[pulumi.Input['DLPWebRulesFileTypeCategoriesArgs']] = None,
                 ...
                 inspect_http_get_enabled: Optional[pulumi.Input[_builtins.bool]] = None,
                 ...
                 zscaler_incident_receiver: Optional[pulumi.Input[_builtins.bool]] = None):
        """
        The set of arguments for constructing a DLPWebRules resource.
        :param pulumi.Input[_builtins.int] order: The rule order of execution for the DLP policy rule with respect to other rules.
        :param pulumi.Input[_builtins.str] action: The action taken when traffic matches the DLP policy rule criteria.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] cloud_applications: The list of cloud applications to which the DLP policy rule must be applied
        ...
        :param pulumi.Input[_builtins.str] description: The description of the DLP policy rule.
        :param pulumi.Input[_builtins.bool] dlp_download_scan_enabled: Indicates a DLP policy rule without content inspection, when the value is set to true.
        ...
        :param pulumi.Input[_builtins.int] eun_template_id: The EUN template ID associated with the rule
        :param pulumi.Input['DLPWebRulesExcludedDepartmentsArgs'] excluded_departments: The Name-ID pairs of departments which the DLP policy rule must exclude
        :param pulumi.Input['DLPWebRulesExcludedDomainProfilesArgs'] excluded_domain_profiles: The Name-ID pairs of domain profiles to which the DLP policy rule must exclude
        :param pulumi.Input['DLPWebRulesExcludedGroupsArgs'] excluded_groups: The Name-ID pairs of groups which the DLP policy rule must exclude
        :param pulumi.Input['DLPWebRulesExcludedUsersArgs'] excluded_users: The Name-ID pairs of users which the DLP policy rule must exclude
        ...
        :param pulumi.Input['DLPWebRulesFileTypeCategoriesArgs'] file_type_categories: The list of file types to which the rule applies
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] file_types: The list of file types for which the DLP policy rule must be applied,
        ...
        :param pulumi.Input['DLPWebRulesIncludedDomainProfilesArgs'] included_domain_profiles: The Name-ID pairs of domain profiiles which the DLP policy rule must include
        ...
        :param pulumi.Input[_builtins.bool] match_only: The match only criteria for DLP engines.
        :param pulumi.Input[_builtins.int] min_size: The minimum file size (in KB) used for evaluation of the DLP policy rule.
        :param pulumi.Input[_builtins.str] name: The DLP policy rule name.
        ...
        :param pulumi.Input[_builtins.int] parent_rule: The unique identifier of the parent rule under which an exception rule is added
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] protocols: The protocol criteria specified for the DLP policy rule.
        :param pulumi.Input[_builtins.int] rank: Admin rank of the admin who creates this rule
        :param pulumi.Input['DLPWebRulesReceiverArgs'] receiver: The receiver information for the DLP policy rule
        :param pulumi.Input[_builtins.str] severity: Indicates the severity selected for the DLP rule violation
        :param pulumi.Input['DLPWebRulesSourceIpGroupsArgs'] source_ip_groups: list of source ip groups
        :param pulumi.Input[_builtins.str] state: Enables or disables the DLP policy rule.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] sub_rules: The list of exception rules added to a parent rule
        :param pulumi.Input['DLPWebRulesTimeWindowsArgs'] time_windows: list of source ip groups
        ...
        :param pulumi.Input[_builtins.bool] without_content_inspection: Indicates a DLP policy rule without content inspection, when the value is set to true.
        ...
        :param pulumi.Input[_builtins.bool] zcc_notifications_enabled: Indicates a DLP policy rule without content inspection, when the value is set to true.
        :param pulumi.Input[_builtins.bool] zscaler_incident_receiver: Indicates whether a Zscaler Incident Receiver is associated to the DLP policy rule
        """
    ...
    def file_type_categories(self) -> Optional[pulumi.Input['DLPWebRulesFileTypeCategoriesArgs']]:
        """
    ...
    def file_type_categories(self, value: Optional[pulumi.Input['DLPWebRulesFileTypeCategoriesArgs']]):
    ...
    def inspect_http_get_enabled(self) -> Optional[pulumi.Input[_builtins.bool]]:
        return pulumi.get(self, "inspect_http_get_enabled")

    @inspect_http_get_enabled.setter
    def inspect_http_get_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def parent_rule(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    @parent_rule.setter
    def parent_rule(self, value: Optional[pulumi.Input[_builtins.int]]):
    ...
    @_builtins.property
    @pulumi.getter
    def receiver(self) -> Optional[pulumi.Input['DLPWebRulesReceiverArgs']]:
        """
    ...
    @receiver.setter
    def receiver(self, value: Optional[pulumi.Input['DLPWebRulesReceiverArgs']]):
    ...
    def sub_rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    @sub_rules.setter
    def sub_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def zscaler_incident_receiver(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def zscaler_incident_receiver(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class DLPWebRules(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 external_auditor_email: Optional[pulumi.Input[_builtins.str]] = None,
                 file_type_categories: Optional[pulumi.Input[Union['DLPWebRulesFileTypeCategoriesArgs', 'DLPWebRulesFileTypeCategoriesArgsDict']]] = None,
                 file_types: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 ...
                 protocols: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 rank: Optional[pulumi.Input[_builtins.int]] = None,
                 receiver: Optional[pulumi.Input[Union['DLPWebRulesReceiverArgs', 'DLPWebRulesReceiverArgsDict']]] = None,
                 severity: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        **zia_dlp_web_rules** can be imported by using `<RULE ID>` or `<RULE NAME>` as the import ID.
        ...
        :param pulumi.Input[_builtins.int] eun_template_id: The EUN template ID associated with the rule
        :param pulumi.Input[Union['DLPWebRulesExcludedDepartmentsArgs', 'DLPWebRulesExcludedDepartmentsArgsDict']] excluded_departments: The Name-ID pairs of departments which the DLP policy rule must exclude
        :param pulumi.Input[Union['DLPWebRulesExcludedDomainProfilesArgs', 'DLPWebRulesExcludedDomainProfilesArgsDict']] excluded_domain_profiles: The Name-ID pairs of domain profiles to which the DLP policy rule must exclude
        :param pulumi.Input[Union['DLPWebRulesExcludedGroupsArgs', 'DLPWebRulesExcludedGroupsArgsDict']] excluded_groups: The Name-ID pairs of groups which the DLP policy rule must exclude
        :param pulumi.Input[Union['DLPWebRulesExcludedUsersArgs', 'DLPWebRulesExcludedUsersArgsDict']] excluded_users: The Name-ID pairs of users which the DLP policy rule must exclude
        :param pulumi.Input[_builtins.str] external_auditor_email: The email address of an external auditor to whom DLP email notifications are sent
        :param pulumi.Input[Union['DLPWebRulesFileTypeCategoriesArgs', 'DLPWebRulesFileTypeCategoriesArgsDict']] file_type_categories: The list of file types to which the rule applies
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] file_types: The list of file types for which the DLP policy rule must be applied,
               				See the Web DLP Rules API for the list of available File types:
               				https://help.zscaler.com/zia/data-loss-prevention#/webDlpRules-get
        ...
        :param pulumi.Input[Union['DLPWebRulesIncludedDomainProfilesArgs', 'DLPWebRulesIncludedDomainProfilesArgsDict']] included_domain_profiles: The Name-ID pairs of domain profiiles which the DLP policy rule must include
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] protocols: The protocol criteria specified for the DLP policy rule.
        :param pulumi.Input[_builtins.int] rank: Admin rank of the admin who creates this rule
        :param pulumi.Input[Union['DLPWebRulesReceiverArgs', 'DLPWebRulesReceiverArgsDict']] receiver: The receiver information for the DLP policy rule
        :param pulumi.Input[_builtins.str] severity: Indicates the severity selected for the DLP rule violation
        ...
        :param pulumi.Input[_builtins.str] state: Enables or disables the DLP policy rule.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] sub_rules: The list of exception rules added to a parent rule
        :param pulumi.Input[Union['DLPWebRulesTimeWindowsArgs', 'DLPWebRulesTimeWindowsArgsDict']] time_windows: list of source ip groups
    ...
    def get(resource_name: str,
            ...
            workload_groups: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DLPWebRulesWorkloadGroupArgs', 'DLPWebRulesWorkloadGroupArgsDict']]]]] = None,
            zcc_notifications_enabled: Optional[pulumi.Input[_builtins.bool]] = None,
            zscaler_incident_receiver: Optional[pulumi.Input[_builtins.bool]] = None) -> 'DLPWebRules':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dlpDownloadScanEnabled")
    def dlp_download_scan_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Indicates a DLP policy rule without content inspection, when the value is set to true.
        """
        return pulumi.get(self, "dlp_download_scan_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="fileTypeCategories")
    def file_type_categories(self) -> pulumi.Output[Optional['outputs.DLPWebRulesFileTypeCategories']]:
        """
        The list of file types to which the rule applies
        """
        return pulumi.get(self, "file_type_categories")
    ...
    @_builtins.property
    @pulumi.getter(name="inspectHttpGetEnabled")
    def inspect_http_get_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        return pulumi.get(self, "inspect_http_get_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="matchOnly")
    def match_only(self) -> pulumi.Output[_builtins.bool]:
        """
        The match only criteria for DLP engines.
        """
        return pulumi.get(self, "match_only")
    ...
    @_builtins.property
    @pulumi.getter(name="parentRule")
    def parent_rule(self) -> pulumi.Output[_builtins.int]:
        """
        The unique identifier of the parent rule under which an exception rule is added
        """
        return pulumi.get(self, "parent_rule")
    ...
    @_builtins.property
    @pulumi.getter
    def receiver(self) -> pulumi.Output[Optional['outputs.DLPWebRulesReceiver']]:
        """
        The receiver information for the DLP policy rule
        """
        return pulumi.get(self, "receiver")
    ...
    @_builtins.property
    @pulumi.getter(name="subRules")
    def sub_rules(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        The list of exception rules added to a parent rule
        """
        return pulumi.get(self, "sub_rules")
    ...
    @_builtins.property
    @pulumi.getter(name="userRiskScoreLevels")
    def user_risk_score_levels(self) -> pulumi.Output[Sequence[_builtins.str]]:
        return pulumi.get(self, "user_risk_score_levels")
    ...
    @_builtins.property
    @pulumi.getter(name="withoutContentInspection")
    def without_content_inspection(self) -> pulumi.Output[_builtins.bool]:
        """
        Indicates a DLP policy rule without content inspection, when the value is set to true.
        """
        return pulumi.get(self, "without_content_inspection")
    ...
    @_builtins.property
    @pulumi.getter(name="zccNotificationsEnabled")
    def zcc_notifications_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Indicates a DLP policy rule without content inspection, when the value is set to true.
        """
        return pulumi.get(self, "zcc_notifications_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="zscalerIncidentReceiver")
    def zscaler_incident_receiver(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Indicates whether a Zscaler Incident Receiver is associated to the DLP policy rule
        """
        return pulumi.get(self, "zscaler_incident_receiver")
