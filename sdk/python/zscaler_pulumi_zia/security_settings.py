...
class SecuritySettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] blacklist_urls: URLs on the denylist for your organization. Allow up to 275000 URLs.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] whitelist_urls: Allowlist URLs whose contents will not be scanned. Allows up to 255 URLs.
        """
...
class SecuritySettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            blacklist_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            whitelist_urls: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'SecuritySettings':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="blacklistUrls")
    def blacklist_urls(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        URLs on the denylist for your organization. Allow up to 275000 URLs.
        """
        return pulumi.get(self, "blacklist_urls")
    ...
    @_builtins.property
    @pulumi.getter(name="whitelistUrls")
    def whitelist_urls(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Allowlist URLs whose contents will not be scanned. Allows up to 255 URLs.
        """
        return pulumi.get(self, "whitelist_urls")
