...
class GetDLPWebRulesResult:
    ...
    """
    def __init__(__self__, access_control=None, action=None, cloud_applications=None, departments=None, description=None, dlp_download_scan_enabled=None, dlp_engines=None, excluded_departments=None, excluded_groups=None, excluded_users=None, external_auditor_email=None, file_type_categories=None, file_types=None, groups=None, id=None, included_domain_profiles=None, labels=None, last_modified_bies=None, last_modified_time=None, location_groups=None, locations=None, match_only=None, min_size=None, name=None, order=None, parent_rule=None, protocols=None, rank=None, receivers=None, severity=None, source_ip_groups=None, state=None, sub_rules=None, time_windows=None, url_categories=None, users=None, without_content_inspection=None, workload_groups=None, zcc_notifications_enabled=None, zscaler_incident_receiver=None):
    ...
    def cloud_applications(self) -> Sequence[_builtins.str]:
    ...
    def dlp_download_scan_enabled(self) -> _builtins.bool:
    ...
    def external_auditor_email(self) -> _builtins.str:
        return pulumi.get(self, "external_auditor_email")

    @_builtins.property
    @pulumi.getter(name="fileTypeCategories")
    def file_type_categories(self) -> Sequence['outputs.GetDLPWebRulesFileTypeCategoryResult']:
    ...
    def match_only(self) -> _builtins.bool:
    ...
    def parent_rule(self) -> _builtins.int:
    ...
    @_builtins.property
    @pulumi.getter
    def receivers(self) -> Sequence['outputs.GetDLPWebRulesReceiverResult']:
    ...
    def sub_rules(self) -> Sequence[_builtins.str]:
    ...
    def without_content_inspection(self) -> _builtins.bool:
    ...
    def zcc_notifications_enabled(self) -> _builtins.bool:
        return pulumi.get(self, "zcc_notifications_enabled")

    @_builtins.property
    @pulumi.getter(name="zscalerIncidentReceiver")
    def zscaler_incident_receiver(self) -> _builtins.bool:
...
def get_dlp_web_rules(id: Optional[_builtins.int] = None,
...
def get_dlp_web_rules_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
