...
class GetFileTypeControlRulesResult:
    ...
    def active_content(self) -> _builtins.bool:
    ...
    @_builtins.property
    @pulumi.getter
    def unscannable(self) -> _builtins.bool:
...
def get_file_type_control_rules(id: Optional[_builtins.int] = None,
...
def get_file_type_control_rules_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
