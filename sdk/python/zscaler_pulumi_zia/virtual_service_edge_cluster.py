...
class VirtualServiceEdgeClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] default_gateway: The IP address of the default gateway to the internet
        :param pulumi.Input[_builtins.str] ip_address: The Virtual Service Edge cluster IP address
        ...
        :param pulumi.Input[_builtins.str] name: Name of the Virtual Service Edge cluster
        ...
        :param pulumi.Input[_builtins.str] subnet_mask: The Virtual Service Edge cluster subnet mask
        :param pulumi.Input[_builtins.str] type: The Virtual Service Edge cluster type. Supported values: `ANY`, `NONE`, `SME`, `SMSM`, `SMCA`, `SMUI`, `SMCDS`, `SMDNSD`, `SMAA`, `SMTP`, `SMQTN`, `VIP`, `UIZ`, `UIAE`, `SITEREVIEW`, `PAC`, `S_RELAY`, `M_RELAY`, `H_MON`, `SMIKE`, `NSS`, `SMEZA`, `SMLB`, `SMFCCLT`, `SMBA`, `SMBAC`, `SMESXI`, `SMBAUI`, `VZEN`, `ZSCMCLT`, `SMDLP`, `ZSQUERY`, `ADP`, `SMCDSDLP`, `SMSCIM`, `ZSAPI`, `ZSCMCDSSCLT`, `LOCAL_MTS`, `SVPN`, `SMCASB`, `SMFALCONUI`, `MOBILEAPP_REG`, `SMRESTSVR`, `FALCONCA`, `MOBILEAPP_NF`, `ZIRSVR`, `SMEDGEUI`, `ALERTEVAL`, `ALERTNOTIF`, `SMPARTNERUI`, `CQM`, `DATAKEEPER`, `SMBAM`, `ZWACLT`
        :param pulumi.Input['VirtualServiceEdgeClusterVirtualZenNodesArgs'] virtual_zen_nodes: List of ZPA Application Segments for which this rule is applicable. This field is applicable only for the ECZPA forwarding method (used for Zscaler Cloud Connector)
        """
...
class VirtualServiceEdgeCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **zia_virtual_service_edge_cluster** can be imported by using `<CLUSTER_ID>` or `<CLUSTER_NAME>` as the import ID.
        ...
        :param pulumi.Input[_builtins.str] subnet_mask: The Virtual Service Edge cluster subnet mask
        :param pulumi.Input[_builtins.str] type: The Virtual Service Edge cluster type. Supported values: `ANY`, `NONE`, `SME`, `SMSM`, `SMCA`, `SMUI`, `SMCDS`, `SMDNSD`, `SMAA`, `SMTP`, `SMQTN`, `VIP`, `UIZ`, `UIAE`, `SITEREVIEW`, `PAC`, `S_RELAY`, `M_RELAY`, `H_MON`, `SMIKE`, `NSS`, `SMEZA`, `SMLB`, `SMFCCLT`, `SMBA`, `SMBAC`, `SMESXI`, `SMBAUI`, `VZEN`, `ZSCMCLT`, `SMDLP`, `ZSQUERY`, `ADP`, `SMCDSDLP`, `SMSCIM`, `ZSAPI`, `ZSCMCDSSCLT`, `LOCAL_MTS`, `SVPN`, `SMCASB`, `SMFALCONUI`, `MOBILEAPP_REG`, `SMRESTSVR`, `FALCONCA`, `MOBILEAPP_NF`, `ZIRSVR`, `SMEDGEUI`, `ALERTEVAL`, `ALERTNOTIF`, `SMPARTNERUI`, `CQM`, `DATAKEEPER`, `SMBAM`, `ZWACLT`
        :param pulumi.Input[Union['VirtualServiceEdgeClusterVirtualZenNodesArgs', 'VirtualServiceEdgeClusterVirtualZenNodesArgsDict']] virtual_zen_nodes: List of ZPA Application Segments for which this rule is applicable. This field is applicable only for the ECZPA forwarding method (used for Zscaler Cloud Connector)
        """
        ...
    @overload
    def __init__(__self__,
