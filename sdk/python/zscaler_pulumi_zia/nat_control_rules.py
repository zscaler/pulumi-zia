...
class NatControlRulesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the nat control policy rule
        ...
        :param pulumi.Input[_builtins.int] rank: Admin rank of the nat control policy rule
        :param pulumi.Input[_builtins.str] redirect_fqdn: The action the nat control policy rule takes when packets match the rule
        :param pulumi.Input[_builtins.str] redirect_ip: The action the nat control policy rule takes when packets match the rule
        :param pulumi.Input[_builtins.int] redirect_port: The action the nat control policy rule takes when packets match the rule
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] res_categories: List of destination domain categories to which the rule applies
        ...
        :param pulumi.Input[_builtins.str] state: Determines whether the nat control policy rule is enabled or disabled
