...
class AdvancedThreatSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] activex_blocked: A Boolean value specifying whether sites are allowed or blocked from accessing vulnerable ActiveX controls that are known to have been exploited.
        :param pulumi.Input[_builtins.bool] activex_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for ActiveX controls
        :param pulumi.Input[_builtins.bool] ad_spyware_sites_blocked: A Boolean value specifying whether to allow or block websites known to contain adware or spyware that displays malicious advertisements that can collect users' information without their knowledge
        :param pulumi.Input[_builtins.bool] ad_spyware_sites_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for adware and spyware sites
        :param pulumi.Input[_builtins.bool] alert_for_unknown_suspicious_c2_traffic: A Boolean value specifying whether to send alerts upon detecting unknown or suspicious C2 traffic
        :param pulumi.Input[_builtins.bool] anonymizer_blocked: A Boolean value specifying whether to allow or block applications and methods used to obscure the destination and the content accessed by the user, therefore blocking traffic to anonymizing web proxies
        :param pulumi.Input[_builtins.bool] anonymizer_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for anonymizers
        :param pulumi.Input[_builtins.bool] bit_torrent_blocked: A Boolean value specifying whether packet capture (PCAP) is enabled or not for blocked countries
        :param pulumi.Input[_builtins.bool] bit_torrent_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for BitTorrent
        :param pulumi.Input[_builtins.bool] block_countries_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for blocked countries
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] blocked_countries: Destination countries for which the rule is applicable. If not set, the rule is not restricted to specific destination countries.
        :param pulumi.Input[_builtins.bool] browser_exploits_blocked: A Boolean value specifying whether known web browser vulnerabilities prone to exploitation are allowed or blocked.
        :param pulumi.Input[_builtins.bool] browser_exploits_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for browser exploits
        :param pulumi.Input[_builtins.bool] cmd_ctl_server_blocked: A Boolean value specifying whether connections to known Command & Control (C2) Servers are allowed or blocked
        :param pulumi.Input[_builtins.bool] cmd_ctl_server_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for connections to known C2 servers
        :param pulumi.Input[_builtins.bool] cmd_ctl_traffic_blocked: A Boolean value specifying whether botnets are allowed or blocked from sending or receiving commands to unknown servers
        :param pulumi.Input[_builtins.bool] cmd_ctl_traffic_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for botnets
        :param pulumi.Input[_builtins.bool] cookie_stealing_blocked: A Boolean value specifying whether to allow or block third-party websites that gather cookie information
        :param pulumi.Input[_builtins.bool] cookie_stealing_pcap_enabled: A Boolean value specifying whether packet capture (PCAP) is enabled or not for cookie stealing
        :param pulumi.Input[_builtins.bool] crypto_mining_blocked: A Boolean value specifying whether to allow or block cryptocurrency mining network traffic and script
        :param pulumi.Input[_builtins.bool] crypto_mining_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for cryptomining
        :param pulumi.Input[_builtins.bool] dga_domains_blocked: A Boolean value specifying whether to allow or block domains that are suspected to be generated using domain generation algorithms (DGA)
        :param pulumi.Input[_builtins.bool] dga_domains_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for DGA domains
        :param pulumi.Input[_builtins.bool] file_format_vunerabilites_blocked: A Boolean value specifying whether known file format vulnerabilities and suspicious or malicious content in Microsoft Office or PDF documents are allowed or blocked
        :param pulumi.Input[_builtins.bool] file_format_vunerabilites_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for file format vulnerabilities
        :param pulumi.Input[_builtins.bool] google_talk_blocked: A Boolean value specifying whether to allow or block access to Google Hangouts, a popular P2P VoIP application.
        :param pulumi.Input[_builtins.bool] google_talk_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for Google Hangouts
        :param pulumi.Input[_builtins.bool] irc_tunnelling_blocked: A Boolean value specifying whether packet capture (PCAP) is enabled or not for web spam
        :param pulumi.Input[_builtins.bool] irc_tunnelling_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for IRC tunnels
        :param pulumi.Input[_builtins.bool] known_phishing_sites_blocked: A Boolean value specifying whether known phishing sites are allowed or blocked
        :param pulumi.Input[_builtins.bool] known_phishing_sites_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for known phishing sites
        :param pulumi.Input[_builtins.bool] malicious_urls_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for malicious URLs
        :param pulumi.Input[_builtins.bool] malware_sites_blocked: A Boolean value specifying whether known malicious sites and content are allowed or blocked
        :param pulumi.Input[_builtins.bool] malware_sites_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for malicious sites
        :param pulumi.Input[_builtins.bool] potential_malicious_requests_blocked: A Boolean value specifying whether to allow or block this type of cross-site scripting (XSS)
        :param pulumi.Input[_builtins.bool] potential_malicious_requests_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for (XSS) attacks
        :param pulumi.Input[_builtins.int] risk_tolerance: The Page Risk tolerance index set between 0 and 100 (100 being the highest risk).
        :param pulumi.Input[_builtins.bool] risk_tolerance_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for suspicious web pages
        :param pulumi.Input[_builtins.bool] ssh_tunnelling_blocked: A Boolean value specifying whether to allow or block SSH traffic being tunneled over HTTP/Ss
        :param pulumi.Input[_builtins.bool] ssh_tunnelling_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for SSH tunnels
        :param pulumi.Input[_builtins.bool] suspect_adware_spyware_sites_blocked: A Boolean value specifying whether to allow or block any detections of communication and callback traffic associated with spyware agents and data transmission
        :param pulumi.Input[_builtins.bool] suspect_adware_spyware_sites_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for suspected adware and spyware sites
        :param pulumi.Input[_builtins.bool] suspected_phishing_sites_blocked: A Boolean value specifying whether to allow or block suspected phishing sites identified through heuristic detection.
        :param pulumi.Input[_builtins.bool] suspected_phishing_sites_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for suspected phishing sites
        :param pulumi.Input[_builtins.bool] tor_blocked: A Boolean value specifying whether to allow or block the usage of Tor, a popular P2P anonymizer protocol with support for encryption.
        :param pulumi.Input[_builtins.bool] tor_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for Tor
        :param pulumi.Input[_builtins.bool] web_spam_blocked: A Boolean value specifying whether to allow or block web pages that pretend to contain useful information, to get higher ranking in search engine results or drive traffic to phishing, adware, or spyware distribution sites.
        :param pulumi.Input[_builtins.bool] web_spam_capture: A Boolean value specifying whether packet capture (PCAP) is enabled or not for web spam
        """
...
class AdvancedThreatSettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tor_capture: Optional[pulumi.Input[_builtins.bool]] = None,
            web_spam_blocked: Optional[pulumi.Input[_builtins.bool]] = None,
            web_spam_capture: Optional[pulumi.Input[_builtins.bool]] = None) -> 'AdvancedThreatSettings':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="blockedCountries")
    def blocked_countries(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Destination countries for which the rule is applicable. If not set, the rule is not restricted to specific destination countries.
        """
        return pulumi.get(self, "blocked_countries")
