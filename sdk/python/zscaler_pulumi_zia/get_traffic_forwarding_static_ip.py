...
class GetTrafficForwardingStaticIPResult:
    ...
    def geo_override(self) -> _builtins.bool:
        """
    ...
    def routable_ip(self) -> _builtins.bool:
        """
...
def get_traffic_forwarding_static_ip(id: Optional[_builtins.int] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/traffic-forwarding-0#/staticIP-get)
    ...
    :param _builtins.str ip_address: The static IP address
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_traffic_forwarding_static_ip_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
