...
def get_firewall_filtering_application_groups(id: Optional[_builtins.int] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/firewall-policies#/networkApplicationGroups/{groupId}-get)
    ...
    :param _builtins.int id: The ID of the ip source group resource.
...
def get_firewall_filtering_application_groups_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
