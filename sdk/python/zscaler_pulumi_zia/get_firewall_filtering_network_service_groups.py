...
def get_firewall_filtering_network_service_groups(id: Optional[_builtins.int] = None,
...
def get_firewall_filtering_network_service_groups_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
