...
class GetEndUserNotificationResult:
    ...
    def idp_proxy_notification_text(self) -> _builtins.str:
    ...
    def org_policy_link(self) -> _builtins.str:
        return pulumi.get(self, "org_policy_link")

    @_builtins.property
    @pulumi.getter(name="quarantineCustomNotificationText")
    def quarantine_custom_notification_text(self) -> _builtins.str:
