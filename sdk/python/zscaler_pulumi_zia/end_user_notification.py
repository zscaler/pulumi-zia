...
class EndUserNotificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] aup_custom_frequency: The custom frequency (in days) for showing the AUP to the end users. Valid range is 0 to 180.
        :param pulumi.Input[_builtins.int] aup_day_offset: Specifies which day of the week or month the AUP is shown for users when aupFrequency is set. Valid range is 0 to 31.
        :param pulumi.Input[_builtins.str] aup_frequency: The frequency at which the Acceptable Use Policy (AUP) is shown to the end users
        :param pulumi.Input[_builtins.str] aup_message: The acceptable use statement that is shown in the AUP
        :param pulumi.Input[_builtins.int] caution_again_after: The time interval at which the caution notification is shown when users continue browsing a restricted site.
        :param pulumi.Input[_builtins.str] caution_custom_text: The custom message that appears in the caution notification
        :param pulumi.Input[_builtins.bool] caution_per_domain: Specifies whether to display the caution notification at a specific time interval for URLs in the Miscellaneous or Unknown category.
        :param pulumi.Input[_builtins.str] custom_text: The custom text shown in the EUN
        :param pulumi.Input[_builtins.bool] display_company_logo: A Boolean value indicating whether your organization's logo appears in the EUN or not
        :param pulumi.Input[_builtins.bool] display_company_name: A Boolean value indicating whether the organization's name appears in the EUN or not
        :param pulumi.Input[_builtins.bool] display_reason: A Boolean value indicating whether or not the reason for cautioning or blocking access to a site, file, or application is shown when the respective notification is triggered
        :param pulumi.Input[_builtins.str] idp_proxy_notification_text: The message that appears in the IdP Proxy notification
        :param pulumi.Input[_builtins.str] notification_type: The type of EUN as default or custom
        :param pulumi.Input[_builtins.str] org_policy_link: The URL of the organization's policy page. This field is required for the default notification type.
        :param pulumi.Input[_builtins.str] quarantine_custom_notification_text: The message that appears in the quarantine notification
        :param pulumi.Input[_builtins.str] redirect_url: The redirect URL for the external site hosting the EUN specified when the custom notification type is selected
        :param pulumi.Input[_builtins.str] security_review_custom_location: Value indicating whether or not to include the ECS option in all DNS queries, originating from all locations and remote users.
        :param pulumi.Input[_builtins.bool] security_review_enabled: A Boolean value indicating whether the Security Violation notification is enabled or disabled
        :param pulumi.Input[_builtins.bool] security_review_submit_to_security_cloud: A Boolean value indicating whether users' review requests for blocked URLs are submitted to the Zscaler service (i.e., Security Cloud) or a custom location.
        :param pulumi.Input[_builtins.str] security_review_text: The message that appears in the Security Violation notification
        :param pulumi.Input[_builtins.str] support_email: The email address for writing to IT Support
        :param pulumi.Input[_builtins.str] support_phone: The phone number for contacting IT Support
        :param pulumi.Input[_builtins.str] url_cat_review_custom_location: A custom URL location where users' review requests for blocked URLs are sent
        :param pulumi.Input[_builtins.bool] url_cat_review_enabled: A Boolean value indicating whether the URL Categorization notification is enabled or disabled
        :param pulumi.Input[_builtins.bool] url_cat_review_submit_to_security_cloud: A Boolean value indicating whether users' review requests for possibly misclassified URLs are submitted to the Zscaler service (i.e., Security Cloud) or a custom location.
        :param pulumi.Input[_builtins.str] url_cat_review_text: The message that appears in the URL Categorization notification
        :param pulumi.Input[_builtins.str] web_dlp_review_custom_location: A custom URL location where users' review requests for the web DLP policy violation are sent
        :param pulumi.Input[_builtins.bool] web_dlp_review_enabled: A Boolean value indicating whether the Web DLP Violation notification is enabled or disabled
        :param pulumi.Input[_builtins.bool] web_dlp_review_submit_to_security_cloud: A Boolean value indicating whether users' review requests for web DLP policy violation are submitted to the Zscaler service (i.e., Security Cloud) or a custom location.
        :param pulumi.Input[_builtins.str] web_dlp_review_text: The message that appears in the Web DLP Violation notification
        """
...
class EndUserNotification(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            web_dlp_review_enabled: Optional[pulumi.Input[_builtins.bool]] = None,
            web_dlp_review_submit_to_security_cloud: Optional[pulumi.Input[_builtins.bool]] = None,
            web_dlp_review_text: Optional[pulumi.Input[_builtins.str]] = None) -> 'EndUserNotification':
        """
