...
class UserManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] email: User email consists of a user name and domain name. It does not have to be a valid email address, but it must be unique and its domain must belong to the organization.
        :param pulumi.Input[_builtins.str] password: User's password. Applicable only when authentication type is Hosted DB. Password strength must follow what is defined in the auth settings.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] auth_methods: Accepted Authentication Methods
        :param pulumi.Input[_builtins.str] comments: Additional information about this user.
        ...
        :param pulumi.Input[_builtins.str] temp_auth_email: Temporary Authentication Email. If you enabled one-time tokens or links, enter the email address to which the Zscaler service sends the tokens or links. If this is empty, the service will send the email to the User email.
        """
...
class UserManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[_builtins.str]] = None,
            temp_auth_email: Optional[pulumi.Input[_builtins.str]] = None,
            user_id: Optional[pulumi.Input[_builtins.int]] = None) -> 'UserManagement':
        """
