...
class GetDLPNotificationTemplatesResult:
    ...
    def attach_content(self) -> _builtins.bool:
        return pulumi.get(self, "attach_content")

    @_builtins.property
    @pulumi.getter(name="htmlMessage")
    def html_message(self) -> _builtins.str:
    ...
    def plain_text_message(self) -> _builtins.str:
...
def get_dlp_notification_templates(id: Optional[_builtins.int] = None,
...
def get_dlp_notification_templates_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
