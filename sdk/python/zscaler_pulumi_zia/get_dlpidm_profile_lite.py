...
def get_dlpidm_profile_lite(active_only: Optional[_builtins.bool] = None,
...
def get_dlpidm_profile_lite_output(active_only: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
