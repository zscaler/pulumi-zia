...
class GetTenantRestrictionProfileResult:
    ...
    def last_modified_user_id(self) -> _builtins.int:
        return pulumi.get(self, "last_modified_user_id")

    @_builtins.property
    @pulumi.getter(name="msLoginServicesTrV2")
    def ms_login_services_tr_v2(self) -> _builtins.bool:
    ...
    def restrict_personal_o365_domains(self) -> _builtins.bool:
...
def get_tenant_restriction_profile(description: Optional[_builtins.str] = None,
...
def get_tenant_restriction_profile_output(description: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
