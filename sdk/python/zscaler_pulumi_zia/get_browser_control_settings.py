...
__all__ = [
    'GetBrowserControlSettingsResult',
    'AwaitableGetBrowserControlSettingsResult',
    'get_browser_control_settings',
    'get_browser_control_settings_output',
]

@pulumi.output_type
class GetBrowserControlSettingsResult:
    """
    ...
    def allow_all_browsers(self) -> _builtins.bool:
        """
    ...
    def blocked_chrome_versions(self) -> Sequence[_builtins.str]:
        """
    ...
    def blocked_firefox_versions(self) -> Sequence[_builtins.str]:
        """
    ...
    def blocked_internet_explorer_versions(self) -> Sequence[_builtins.str]:
        """
    ...
    def blocked_opera_versions(self) -> Sequence[_builtins.str]:
        """
    ...
    def blocked_safari_versions(self) -> Sequence[_builtins.str]:
        """
    ...
    def bypass_all_browsers(self) -> _builtins.bool:
        """
    ...
    def bypass_applications(self) -> Sequence[_builtins.str]:
        """
    ...
    def bypass_plugins(self) -> Sequence[_builtins.str]:
        """
    ...
    def enable_smart_browser_isolation(self) -> _builtins.bool:
        """
    ...
    def enable_warnings(self) -> _builtins.bool:
        """
    ...
    def plugin_check_frequency(self) -> _builtins.str:
        """
    ...
    def smart_isolation_profile_id(self) -> _builtins.int:
        return pulumi.get(self, "smart_isolation_profile_id")

    @_builtins.property
    @pulumi.getter(name="smartIsolationProfiles")
    def smart_isolation_profiles(self) -> Sequence['outputs.GetBrowserControlSettingsSmartIsolationProfileResult']:
        """
...
class AwaitableGetBrowserControlSettingsResult(GetBrowserControlSettingsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBrowserControlSettingsResult(
...
def get_browser_control_settings(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBrowserControlSettingsResult:
    """
    ...
    * [API documentation](https://help.zscaler.com/zia/browser-control-policy#/browserControlSettings-get)
    ...
    __ret__ = pulumi.runtime.invoke('zia:index/getBrowserControlSettings:getBrowserControlSettings', __args__, opts=opts, typ=GetBrowserControlSettingsResult).value

    return AwaitableGetBrowserControlSettingsResult(
...
def get_browser_control_settings_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBrowserControlSettingsResult]:
    """
    * [Official documentation](https://help.zscaler.com/zia/configuring-browser-control-policy)
    * [API documentation](https://help.zscaler.com/zia/browser-control-policy#/browserControlSettings-get)
    ...
    __ret__ = pulumi.runtime.invoke_output('zia:index/getBrowserControlSettings:getBrowserControlSettings', __args__, opts=opts, typ=GetBrowserControlSettingsResult)
    return __ret__.apply(lambda __response__: GetBrowserControlSettingsResult(
