...
class AdvancedSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] auth_bypass_apps: Cloud applications that are exempted from cookie authentication
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] auth_bypass_url_categories: URL categories that are exempted from cookie authentication
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] auth_bypass_urls: Custom URLs that are exempted from cookie authentication for users
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] basic_bypass_apps: Cloud applications that are exempted from Basic authentication
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] basic_bypass_url_categories: URL categories that are exempted from Basic authentication
        :param pulumi.Input[_builtins.bool] block_connect_host_sni_mismatch: Value indicating whether CONNECT host and SNI mismatch (i.e., CONNECT host doesn't match the SSL/TLS client hello SNI) is blocked or not
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] block_domain_fronting_apps: Applications which are subjected to Domain Fronting
        :param pulumi.Input[_builtins.bool] block_domain_fronting_on_host_header: Value indicating whether to block or allow HTTP/S transactions in which the FQDN of the request URL is different than the FQDN of the request's host header
        :param pulumi.Input[_builtins.bool] block_http_tunnel_on_non_http_ports: Value indicating whether HTTP CONNECT method requests to non-standard ports are allowed or not (i.e., requests directed to ports other than the standard HTTP/S ports 80 and 443)
        :param pulumi.Input[_builtins.bool] block_non_compliant_http_request_on_http_ports: Value indicating whether to allow or block traffic that is not compliant with RFC HTTP protocol standards
        :param pulumi.Input[_builtins.bool] block_non_http_on_http_port_enabled: Value indicating whether non-HTTP Traffic on HTTP/S ports are allowed or blocked
        :param pulumi.Input[_builtins.bool] cascade_url_filtering: Value indicating whether to apply the URL Filtering policy even when the Cloud App Control policy already allows a transaction explicitly
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] digest_auth_bypass_apps: Cloud applications that are exempted from Digest authentication
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] digest_auth_bypass_url_categories: URL categories that are exempted from Digest authentication
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] digest_auth_bypass_urls: Custom URLs that are exempted from Digest authentication. Cloud applications that are exempted from Digest authentication
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_resolution_on_transparent_proxy_apps: Cloud applications to which DNS optimization on transparent proxy mode applies
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_resolution_on_transparent_proxy_exempt_apps: Cloud applications that are excluded from DNS optimization on transparent proxy mode
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_resolution_on_transparent_proxy_exempt_urls: URLs that are excluded from DNS optimization on transparent proxy mode
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_resolution_on_transparent_proxy_ipv6_apps: Cloud applications to which DNS optimization for IPv6 addresses on transparent proxy mode applies
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_resolution_on_transparent_proxy_ipv6_exempt_apps: Cloud applications that are excluded from DNS optimization for IPv6 addresses on transparent proxy mode
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_resolution_on_transparent_proxy_ipv6_url_categories: IPv6 URL categories to which DNS optimization on transparent proxy mode applies
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_resolution_on_transparent_proxy_url_categories: URL categories to which DNS optimization on transparent proxy mode applies
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_resolution_on_transparent_proxy_urls: URLs to which DNS optimization on transparent proxy mode applies
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] domain_fronting_bypass_url_categories: URL categories that are exempted from domain fronting
        :param pulumi.Input[_builtins.bool] dynamic_user_risk_enabled: Value indicating whether to dynamically update user risk score by tracking risky user activities in real time
        :param pulumi.Input[_builtins.bool] ecs_for_all_enabled: Value indicating whether or not to include the ECS option in all DNS queries, originating from all locations and remote users.
        :param pulumi.Input[_builtins.bool] enable_admin_rank_access: Value indicating whether ranks are enabled for admins to allow admin ranks in policy configuration and management
        :param pulumi.Input[_builtins.bool] enable_dns_resolution_on_transparent_proxy: Value indicating whether DNS optimization is enabled or disabled for Z-Tunnel 2.0 and transparent proxy mode traffic (e.g., traffic via GRE or IPSec tunnels without a PAC file).
        :param pulumi.Input[_builtins.bool] enable_evaluate_policy_on_global_ssl_bypass: Enable/Disable DNS optimization for all IPv6 transparent proxy traffic
        :param pulumi.Input[_builtins.bool] enable_ipv6_dns_optimization_on_all_transparent_proxy: Enable/Disable DNS optimization for all IPv6 transparent proxy traffic
        :param pulumi.Input[_builtins.bool] enable_ipv6_dns_resolution_on_transparent_proxy: Value indicating whether DNS optimization is enabled or disabled for IPv6 connections to dual-stack or IPv6-only destinations sent via Z-Tunnel 2.0 and transparent proxy proxy mode (e.g., traffic via GRE or IPSec tunnels without a PAC file).
        :param pulumi.Input[_builtins.bool] enable_office365: Value indicating whether Microsoft Office 365 One Click Configuration is enabled or not
        :param pulumi.Input[_builtins.bool] enable_policy_for_unauthenticated_traffic: Value indicating whether policies that include user and department criteria can be configured and applied for unauthenticated traffic
        :param pulumi.Input[_builtins.bool] enforce_surrogate_ip_for_windows_app: Enforce Surrogate IP authentication for Windows app traffic
        :param pulumi.Input[_builtins.bool] http2_nonbrowser_traffic_enabled: Value indicating whether or not HTTP/2 should be the default web protocol for accessing various applications at your organizational level
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] http_range_header_remove_url_categories: URL categories for which HTTP range headers must be removed
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] kerberos_bypass_apps: Cloud applications that are exempted from Kerberos authentication
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] kerberos_bypass_url_categories: URL categories that are exempted from Kerberos authentication
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] kerberos_bypass_urls: Custom URLs that are exempted from Kerberos authentication
        :param pulumi.Input[_builtins.bool] log_internal_ip: Value indicating whether to log internal IP address present in X-Forwarded-For (XFF) proxy header or not
        :param pulumi.Input[_builtins.bool] prefer_sni_over_conn_host: Value indicating whether or not to use the SSL/TLS client hello SNI for DNS resolution instead of the CONNECT host for forward proxy connections
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] prefer_sni_over_conn_host_apps: Applications that are exempted from the preferSniOverConnHost setting (i.e., prefer SSL/TLS client hello SNI for DNS resolution instead of the CONNECT host for forward proxy connections)
        :param pulumi.Input[_builtins.bool] sipa_xff_header_enabled: Value indicating whether or not to insert XFF header to all traffic forwarded from ZIA to ZPA, including source IP-anchored and ZIA-inspected ZPA application traffic.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] sni_dns_optimization_bypass_url_categories: URL categories that are excluded from the preferSniOverConnHost setting (i.e., prefer SSL/TLS client hello SNI for DNS resolution instead of the CONNECT host for forward proxy connections)
        :param pulumi.Input[_builtins.bool] track_http_tunnel_on_http_ports: Value indicating whether to apply configured policies on tunneled HTTP traffic sent via a CONNECT method request on port 80
        :param pulumi.Input[_builtins.int] ui_session_timeout: Specifies the login session timeout for admins accessing the ZIA Admin Portal
        :param pulumi.Input[_builtins.bool] zscaler_client_connector1_and_pac_road_warrior_in_firewall: Value indicating whether to apply the Firewall rules configured without a specified location criteria (or with the Road Warrior location) to remote user traffic forwarded via Z-Tunnel 1.0 or PAC files
        """
...
class AdvancedSettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            track_http_tunnel_on_http_ports: Optional[pulumi.Input[_builtins.bool]] = None,
            ui_session_timeout: Optional[pulumi.Input[_builtins.int]] = None,
            zscaler_client_connector1_and_pac_road_warrior_in_firewall: Optional[pulumi.Input[_builtins.bool]] = None) -> 'AdvancedSettings':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="authBypassApps")
    def auth_bypass_apps(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Cloud applications that are exempted from cookie authentication
        """
        return pulumi.get(self, "auth_bypass_apps")
    ...
    @_builtins.property
    @pulumi.getter(name="authBypassUrlCategories")
    def auth_bypass_url_categories(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        URL categories that are exempted from cookie authentication
        """
        return pulumi.get(self, "auth_bypass_url_categories")
    ...
    @_builtins.property
    @pulumi.getter(name="authBypassUrls")
    def auth_bypass_urls(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Custom URLs that are exempted from cookie authentication for users
        """
        return pulumi.get(self, "auth_bypass_urls")
    ...
    @_builtins.property
    @pulumi.getter(name="basicBypassApps")
    def basic_bypass_apps(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Cloud applications that are exempted from Basic authentication
        """
        return pulumi.get(self, "basic_bypass_apps")
    ...
    @_builtins.property
    @pulumi.getter(name="basicBypassUrlCategories")
    def basic_bypass_url_categories(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        URL categories that are exempted from Basic authentication
        """
        return pulumi.get(self, "basic_bypass_url_categories")
    ...
    @_builtins.property
    @pulumi.getter(name="blockConnectHostSniMismatch")
    def block_connect_host_sni_mismatch(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether CONNECT host and SNI mismatch (i.e., CONNECT host doesn't match the SSL/TLS client hello SNI) is blocked or not
        """
        return pulumi.get(self, "block_connect_host_sni_mismatch")
    ...
    @_builtins.property
    @pulumi.getter(name="blockDomainFrontingApps")
    def block_domain_fronting_apps(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Applications which are subjected to Domain Fronting
        """
        return pulumi.get(self, "block_domain_fronting_apps")
    ...
    @_builtins.property
    @pulumi.getter(name="blockDomainFrontingOnHostHeader")
    def block_domain_fronting_on_host_header(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether to block or allow HTTP/S transactions in which the FQDN of the request URL is different than the FQDN of the request's host header
        """
        return pulumi.get(self, "block_domain_fronting_on_host_header")
    ...
    @_builtins.property
    @pulumi.getter(name="blockHttpTunnelOnNonHttpPorts")
    def block_http_tunnel_on_non_http_ports(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether HTTP CONNECT method requests to non-standard ports are allowed or not (i.e., requests directed to ports other than the standard HTTP/S ports 80 and 443)
        """
        return pulumi.get(self, "block_http_tunnel_on_non_http_ports")
    ...
    @_builtins.property
    @pulumi.getter(name="blockNonCompliantHttpRequestOnHttpPorts")
    def block_non_compliant_http_request_on_http_ports(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether to allow or block traffic that is not compliant with RFC HTTP protocol standards
        """
        return pulumi.get(self, "block_non_compliant_http_request_on_http_ports")
    ...
    @_builtins.property
    @pulumi.getter(name="blockNonHttpOnHttpPortEnabled")
    def block_non_http_on_http_port_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether non-HTTP Traffic on HTTP/S ports are allowed or blocked
        """
        return pulumi.get(self, "block_non_http_on_http_port_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="cascadeUrlFiltering")
    def cascade_url_filtering(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether to apply the URL Filtering policy even when the Cloud App Control policy already allows a transaction explicitly
        """
        return pulumi.get(self, "cascade_url_filtering")
    ...
    @_builtins.property
    @pulumi.getter(name="digestAuthBypassApps")
    def digest_auth_bypass_apps(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Cloud applications that are exempted from Digest authentication
        """
        return pulumi.get(self, "digest_auth_bypass_apps")
    ...
    @_builtins.property
    @pulumi.getter(name="digestAuthBypassUrlCategories")
    def digest_auth_bypass_url_categories(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        URL categories that are exempted from Digest authentication
        """
        return pulumi.get(self, "digest_auth_bypass_url_categories")
    ...
    @_builtins.property
    @pulumi.getter(name="digestAuthBypassUrls")
    def digest_auth_bypass_urls(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Custom URLs that are exempted from Digest authentication. Cloud applications that are exempted from Digest authentication
        """
        return pulumi.get(self, "digest_auth_bypass_urls")
    ...
    @_builtins.property
    @pulumi.getter(name="dnsResolutionOnTransparentProxyApps")
    def dns_resolution_on_transparent_proxy_apps(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Cloud applications to which DNS optimization on transparent proxy mode applies
        """
        return pulumi.get(self, "dns_resolution_on_transparent_proxy_apps")
    ...
    @_builtins.property
    @pulumi.getter(name="dnsResolutionOnTransparentProxyExemptApps")
    def dns_resolution_on_transparent_proxy_exempt_apps(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Cloud applications that are excluded from DNS optimization on transparent proxy mode
        """
        return pulumi.get(self, "dns_resolution_on_transparent_proxy_exempt_apps")
    ...
    @_builtins.property
    @pulumi.getter(name="dnsResolutionOnTransparentProxyExemptUrlCategories")
    def dns_resolution_on_transparent_proxy_exempt_url_categories(self) -> pulumi.Output[Sequence[_builtins.str]]:
        return pulumi.get(self, "dns_resolution_on_transparent_proxy_exempt_url_categories")

    @_builtins.property
    @pulumi.getter(name="dnsResolutionOnTransparentProxyExemptUrls")
    def dns_resolution_on_transparent_proxy_exempt_urls(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        URLs that are excluded from DNS optimization on transparent proxy mode
        """
        return pulumi.get(self, "dns_resolution_on_transparent_proxy_exempt_urls")
    ...
    @_builtins.property
    @pulumi.getter(name="dnsResolutionOnTransparentProxyIpv6Apps")
    def dns_resolution_on_transparent_proxy_ipv6_apps(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Cloud applications to which DNS optimization for IPv6 addresses on transparent proxy mode applies
        """
        return pulumi.get(self, "dns_resolution_on_transparent_proxy_ipv6_apps")
    ...
    @_builtins.property
    @pulumi.getter(name="dnsResolutionOnTransparentProxyIpv6ExemptApps")
    def dns_resolution_on_transparent_proxy_ipv6_exempt_apps(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Cloud applications that are excluded from DNS optimization for IPv6 addresses on transparent proxy mode
        """
        return pulumi.get(self, "dns_resolution_on_transparent_proxy_ipv6_exempt_apps")
    ...
    @_builtins.property
    @pulumi.getter(name="dnsResolutionOnTransparentProxyIpv6ExemptUrlCategories")
    def dns_resolution_on_transparent_proxy_ipv6_exempt_url_categories(self) -> pulumi.Output[Sequence[_builtins.str]]:
        return pulumi.get(self, "dns_resolution_on_transparent_proxy_ipv6_exempt_url_categories")

    @_builtins.property
    @pulumi.getter(name="dnsResolutionOnTransparentProxyIpv6UrlCategories")
    def dns_resolution_on_transparent_proxy_ipv6_url_categories(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        IPv6 URL categories to which DNS optimization on transparent proxy mode applies
        """
        return pulumi.get(self, "dns_resolution_on_transparent_proxy_ipv6_url_categories")
    ...
    @_builtins.property
    @pulumi.getter(name="dnsResolutionOnTransparentProxyUrlCategories")
    def dns_resolution_on_transparent_proxy_url_categories(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        URL categories to which DNS optimization on transparent proxy mode applies
        """
        return pulumi.get(self, "dns_resolution_on_transparent_proxy_url_categories")
    ...
    @_builtins.property
    @pulumi.getter(name="dnsResolutionOnTransparentProxyUrls")
    def dns_resolution_on_transparent_proxy_urls(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        URLs to which DNS optimization on transparent proxy mode applies
        """
        return pulumi.get(self, "dns_resolution_on_transparent_proxy_urls")
    ...
    @_builtins.property
    @pulumi.getter(name="domainFrontingBypassUrlCategories")
    def domain_fronting_bypass_url_categories(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        URL categories that are exempted from domain fronting
        """
        return pulumi.get(self, "domain_fronting_bypass_url_categories")
    ...
    @_builtins.property
    @pulumi.getter(name="dynamicUserRiskEnabled")
    def dynamic_user_risk_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether to dynamically update user risk score by tracking risky user activities in real time
        """
        return pulumi.get(self, "dynamic_user_risk_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="ecsForAllEnabled")
    def ecs_for_all_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether or not to include the ECS option in all DNS queries, originating from all locations and remote users.
        """
        return pulumi.get(self, "ecs_for_all_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="enableAdminRankAccess")
    def enable_admin_rank_access(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether ranks are enabled for admins to allow admin ranks in policy configuration and management
        """
        return pulumi.get(self, "enable_admin_rank_access")
    ...
    @_builtins.property
    @pulumi.getter(name="enableDnsResolutionOnTransparentProxy")
    def enable_dns_resolution_on_transparent_proxy(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether DNS optimization is enabled or disabled for Z-Tunnel 2.0 and transparent proxy mode traffic (e.g., traffic via GRE or IPSec tunnels without a PAC file).
        """
        return pulumi.get(self, "enable_dns_resolution_on_transparent_proxy")
    ...
    @_builtins.property
    @pulumi.getter(name="enableEvaluatePolicyOnGlobalSslBypass")
    def enable_evaluate_policy_on_global_ssl_bypass(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable/Disable DNS optimization for all IPv6 transparent proxy traffic
        """
        return pulumi.get(self, "enable_evaluate_policy_on_global_ssl_bypass")
    ...
    @_builtins.property
    @pulumi.getter(name="enableIpv6DnsOptimizationOnAllTransparentProxy")
    def enable_ipv6_dns_optimization_on_all_transparent_proxy(self) -> pulumi.Output[_builtins.bool]:
        """
        Enable/Disable DNS optimization for all IPv6 transparent proxy traffic
        """
        return pulumi.get(self, "enable_ipv6_dns_optimization_on_all_transparent_proxy")
    ...
    @_builtins.property
    @pulumi.getter(name="enableIpv6DnsResolutionOnTransparentProxy")
    def enable_ipv6_dns_resolution_on_transparent_proxy(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether DNS optimization is enabled or disabled for IPv6 connections to dual-stack or IPv6-only destinations sent via Z-Tunnel 2.0 and transparent proxy proxy mode (e.g., traffic via GRE or IPSec tunnels without a PAC file).
        """
        return pulumi.get(self, "enable_ipv6_dns_resolution_on_transparent_proxy")
    ...
    @_builtins.property
    @pulumi.getter(name="enableOffice365")
    def enable_office365(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether Microsoft Office 365 One Click Configuration is enabled or not
        """
        return pulumi.get(self, "enable_office365")
    ...
    @_builtins.property
    @pulumi.getter(name="enablePolicyForUnauthenticatedTraffic")
    def enable_policy_for_unauthenticated_traffic(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether policies that include user and department criteria can be configured and applied for unauthenticated traffic
        """
        return pulumi.get(self, "enable_policy_for_unauthenticated_traffic")
    ...
    @_builtins.property
    @pulumi.getter(name="enforceSurrogateIpForWindowsApp")
    def enforce_surrogate_ip_for_windows_app(self) -> pulumi.Output[_builtins.bool]:
        """
        Enforce Surrogate IP authentication for Windows app traffic
        """
        return pulumi.get(self, "enforce_surrogate_ip_for_windows_app")
    ...
    @_builtins.property
    @pulumi.getter(name="http2NonbrowserTrafficEnabled")
    def http2_nonbrowser_traffic_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether or not HTTP/2 should be the default web protocol for accessing various applications at your organizational level
        """
        return pulumi.get(self, "http2_nonbrowser_traffic_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="httpRangeHeaderRemoveUrlCategories")
    def http_range_header_remove_url_categories(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        URL categories for which HTTP range headers must be removed
        """
        return pulumi.get(self, "http_range_header_remove_url_categories")
    ...
    @_builtins.property
    @pulumi.getter(name="kerberosBypassApps")
    def kerberos_bypass_apps(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Cloud applications that are exempted from Kerberos authentication
        """
        return pulumi.get(self, "kerberos_bypass_apps")
    ...
    @_builtins.property
    @pulumi.getter(name="kerberosBypassUrlCategories")
    def kerberos_bypass_url_categories(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        URL categories that are exempted from Kerberos authentication
        """
        return pulumi.get(self, "kerberos_bypass_url_categories")
    ...
    @_builtins.property
    @pulumi.getter(name="kerberosBypassUrls")
    def kerberos_bypass_urls(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Custom URLs that are exempted from Kerberos authentication
        """
        return pulumi.get(self, "kerberos_bypass_urls")
    ...
    @_builtins.property
    @pulumi.getter(name="logInternalIp")
    def log_internal_ip(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether to log internal IP address present in X-Forwarded-For (XFF) proxy header or not
        """
        return pulumi.get(self, "log_internal_ip")
    ...
    @_builtins.property
    @pulumi.getter(name="preferSniOverConnHost")
    def prefer_sni_over_conn_host(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether or not to use the SSL/TLS client hello SNI for DNS resolution instead of the CONNECT host for forward proxy connections
        """
        return pulumi.get(self, "prefer_sni_over_conn_host")
    ...
    @_builtins.property
    @pulumi.getter(name="preferSniOverConnHostApps")
    def prefer_sni_over_conn_host_apps(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Applications that are exempted from the preferSniOverConnHost setting (i.e., prefer SSL/TLS client hello SNI for DNS resolution instead of the CONNECT host for forward proxy connections)
        """
        return pulumi.get(self, "prefer_sni_over_conn_host_apps")
    ...
    @_builtins.property
    @pulumi.getter(name="sipaXffHeaderEnabled")
    def sipa_xff_header_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether or not to insert XFF header to all traffic forwarded from ZIA to ZPA, including source IP-anchored and ZIA-inspected ZPA application traffic.
        """
        return pulumi.get(self, "sipa_xff_header_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="sniDnsOptimizationBypassUrlCategories")
    def sni_dns_optimization_bypass_url_categories(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        URL categories that are excluded from the preferSniOverConnHost setting (i.e., prefer SSL/TLS client hello SNI for DNS resolution instead of the CONNECT host for forward proxy connections)
        """
        return pulumi.get(self, "sni_dns_optimization_bypass_url_categories")
    ...
    @_builtins.property
    @pulumi.getter(name="trackHttpTunnelOnHttpPorts")
    def track_http_tunnel_on_http_ports(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether to apply configured policies on tunneled HTTP traffic sent via a CONNECT method request on port 80
        """
        return pulumi.get(self, "track_http_tunnel_on_http_ports")
    ...
    @_builtins.property
    @pulumi.getter(name="uiSessionTimeout")
    def ui_session_timeout(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the login session timeout for admins accessing the ZIA Admin Portal
        """
        return pulumi.get(self, "ui_session_timeout")
    ...
    @_builtins.property
    @pulumi.getter(name="zscalerClientConnector1AndPacRoadWarriorInFirewall")
    def zscaler_client_connector1_and_pac_road_warrior_in_firewall(self) -> pulumi.Output[_builtins.bool]:
        """
        Value indicating whether to apply the Firewall rules configured without a specified location criteria (or with the Road Warrior location) to remote user traffic forwarded via Z-Tunnel 1.0 or PAC files
        """
        return pulumi.get(self, "zscaler_client_connector1_and_pac_road_warrior_in_firewall")
