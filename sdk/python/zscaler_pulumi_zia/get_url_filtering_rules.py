...
class GetURLFilteringRulesResult:
    ...
    def block_override(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def ciparule(self) -> _builtins.bool:
    ...
    def end_user_notification_url(self) -> _builtins.str:
        """
...
def get_url_filtering_rules(id: Optional[_builtins.int] = None,
...
def get_url_filtering_rules_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
