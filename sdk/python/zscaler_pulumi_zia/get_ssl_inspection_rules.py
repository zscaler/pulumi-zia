...
class GetSSLInspectionRulesResult:
    ...
    def road_warrior_for_kerberos(self) -> _builtins.bool:
        """
    ...
    def url_categories(self) -> Optional[Sequence[_builtins.str]]:
        """
        The list of URL categories to which the DLP policy rule must be applied.
        """
...
def get_ssl_inspection_rules(id: Optional[_builtins.int] = None,
                             name: Optional[_builtins.str] = None,
                             url_categories: Optional[Sequence[_builtins.str]] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/ssl-inspection-policy#/sslInspectionRules-get)
    ...
    :param Sequence[_builtins.str] url_categories: The list of URL categories to which the DLP policy rule must be applied.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_ssl_inspection_rules_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                    name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    url_categories: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
