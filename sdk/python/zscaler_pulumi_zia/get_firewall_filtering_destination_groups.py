...
class GetFirewallFilteringDestinationGroupsResult:
    ...
    def ip_categories(self) -> Sequence[_builtins.str]:
        """
...
def get_firewall_filtering_destination_groups(id: Optional[_builtins.int] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/firewall-policies#/ipDestinationGroups-post)
    ...
    :param _builtins.int id: The ID of the destination group resource.
    :param _builtins.str name: The name of the destination group to be exported.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_firewall_filtering_destination_groups_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
