...
def get_dlpedm_schema(project_name: Optional[_builtins.str] = None,
...
def get_dlpedm_schema_output(project_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
