...
class SubCloudArgs:
    ...
    @exclusions.setter
    def exclusions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SubCloudExclusionInputArgs']]]]):
        pulumi.set(self, "exclusions", value)


@pulumi.type_token("zia:index:SubCloud")
class SubCloud(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SubCloud':
        """
