...
class FirewallDNSRuleArgs:
    def __init__(__self__, *,
                 ...
                 default_dns_rule_name_used: Optional[pulumi.Input[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.int] order: (Integer) Policy rules are evaluated in ascending numerical order (Rule 1 before Rule 2, and so on), and the Rule Order reflects this rule's place in the order.
        :param pulumi.Input[_builtins.str] action: (String) The action configured for the rule that must take place if the traffic matches the rule criteria, such as allowing or blocking the traffic or bypassing the rule. The following actions are accepted: `ALLOW`, `BLOCK`, `REDIR_REQ`, `REDIR_RES`, `REDIR_ZPA`, `REDIR_REQ_DOH`, `REDIR_REQ_KEEP_SENDER`, `REDIR_REQ_TCP`, `REDIR_REQ_UDP`, `BLOCK_WITH_RESPONSE`
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] applications: (Set of Strings) DNS tunnels and network applications to which the rule applies. To retrieve the available list of DNS tunnels applications use the data source: `get_cloud_applications` with the `app_class` value `DNS_OVER_HTTPS`. For the complete list of supported file types refer to the  [ZIA API documentation](https://help.zscaler.com/zia/data-loss-prevention#/webDlpRules-post). To retrieve the list of cloud applications, use the data source: `get_cloud_applications`
        :param pulumi.Input[_builtins.str] block_response_code: (String) Specifies the DNS response code to be sent to the client when the action is configured to block and send response code. Supported values are: `ANY`, `NONE`, `FORMERR`, `SERVFAIL`, `NXDOMAIN`, `NOTIMP`, `REFUSED`, `YXDOMAIN`, `YXRRSET`, `NXRRSET`, `NOTAUTH`, `NOTZONE`, `BADVERS`, `BADKEY`, `BADTIME`, `BADMODE`, `BADNAME`, `BADALG`, `BADTRUNC`, `UNSUPPORTED`, `BYPASS`, `INT_ERROR`, `SRV_TIMEOUT`, `EMPTY_RESP`,
               `REQ_BLOCKED`, `ADMIN_DROP`, `WCDN_TIMEOUT`, `IPS_BLOCK`, `FQDN_RESOLV_FAIL`
        :param pulumi.Input[_builtins.bool] capture_pcap: (Boolean) Value that indicates whether packet capture (PCAP) is enabled or not
        :param pulumi.Input[_builtins.bool] default_dns_rule_name_used: (Boolean) A Boolean value that indicates whether the default DNS rule name is used for the rule.
        :param pulumi.Input[_builtins.bool] default_rule: (Boolean) Value that indicates whether the rule is the Default Cloud DNS Rule or not
        ...
        :param pulumi.Input[_builtins.str] description: (String) Enter additional notes or information. The description cannot exceed 10,240 characters.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dest_addresses: (Set of String) Destination IP addresses or FQDNs to which the rule applies. If not set, the rule is not restricted to a specific destination IP address. Each IP entry can be a single IP address, CIDR (e.g., 10.10.33.0/24), or an IP range (e.g., 10.10.33.1-10.10.33.10).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dest_countries: (Set of String) Identify destinations based on the location of a server, select Any to apply the rule to all countries or select the countries to which you want to control traffic.
               **NOTE**: Provide a 2 letter [ISO3166 Alpha2 Country code](https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes). i.e ``"US"``, ``"CA"``
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dest_ip_categories: (Set of String)  identify destinations based on the URL category of the domain, select Any to apply the rule to all categories or select the specific categories you want to control.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] dns_rule_request_types: (Set of Strings) DNS request types to which the rule applies. Supportedn values are:
        ...
        :param pulumi.Input[_builtins.bool] is_web_eun_enabled: (Boolean) A Boolean value that indicates whether Enhanced User Notification (EUN) is enabled for the rule.
        ...
        :param pulumi.Input[_builtins.bool] predefined: (Boolean) A Boolean field that indicates that the rule is predefined by using a true value
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] protocols: (Set of Strings) The protocols to which the rules applies. Supported Values: `ANY_RULE`, `SMRULEF_CASCADING_ALLOWED`, `TCP_RULE`, `UDP_RULE`, `DOHTTPS_RULE`
        :param pulumi.Input[_builtins.int] rank: (Integer) By default, the admin ranking is disabled. To use this feature, you must enable admin rank in UI first. The default value is `7`. Visit to learn more [About Admin Rank](https://help.zscaler.com/zia/about-admin-rank)
        :param pulumi.Input[_builtins.str] redirect_ip: (String) The IP address to which the traffic will be redirected to when the DNAT rule is triggered. If not set, no redirection is done to specific IP addresses. Only supported when the `action` is `REDIR_REQ`
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] res_categories: (Set of String) URL categories associated with resolved IP addresses to which the rule applies. If not set, the rule is not restricted to a specific URL category.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] source_countries: (Set of String) The countries of origin of traffic for which the rule is applicable. If not set, the rule is not restricted to specific source countries.
               **NOTE**: Provide a 2 letter [ISO3166 Alpha2 Country code](https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes). i.e ``"US"``, ``"CA"``
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] src_ips: (Set of String) Source IP addresses or FQDNs to which the rule applies. If not set, the rule is not restricted to a specific source IP address. Each IP entry can be a single IP address, CIDR (e.g., 10.10.33.0/24), or an IP range (e.g., 10.10.33.1-10.10.33.10).
        ...
        :param pulumi.Input[_builtins.str] state: (Optional) An enabled rule is actively enforced. A disabled rule is not actively enforced but does not lose its place in the Rule Order. The service skips it and moves to the next rule. Supported Values: `ENABLED`, `DISABLED`
        ...
        if default_dns_rule_name_used is not None:
            pulumi.set(__self__, "default_dns_rule_name_used", default_dns_rule_name_used)
    ...
    @_builtins.property
    @pulumi.getter(name="defaultDnsRuleNameUsed")
    def default_dns_rule_name_used(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        (Boolean) A Boolean value that indicates whether the default DNS rule name is used for the rule.
        """
        return pulumi.get(self, "default_dns_rule_name_used")

    @default_dns_rule_name_used.setter
    def default_dns_rule_name_used(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "default_dns_rule_name_used", value)
...
class FirewallDNSRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["default_dns_rule_name_used"] = default_dns_rule_name_used
    ...
    @_builtins.property
    @pulumi.getter(name="capturePcap")
    def capture_pcap(self) -> pulumi.Output[_builtins.bool]:
        """
        (Boolean) Value that indicates whether packet capture (PCAP) is enabled or not
        """
        return pulumi.get(self, "capture_pcap")
    ...
    @_builtins.property
    @pulumi.getter(name="defaultDnsRuleNameUsed")
    def default_dns_rule_name_used(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        (Boolean) A Boolean value that indicates whether the default DNS rule name is used for the rule.
        """
        return pulumi.get(self, "default_dns_rule_name_used")
