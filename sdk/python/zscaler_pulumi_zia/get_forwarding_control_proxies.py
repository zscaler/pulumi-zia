...
class GetForwardingControlProxiesResult:
    ...
    def base64_encode_xau_header(self) -> _builtins.bool:
        """
    ...
    def insert_xau_header(self) -> _builtins.bool:
        """
...
def get_forwarding_control_proxies(id: Optional[_builtins.int] = None,
...
def get_forwarding_control_proxies_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
