...
class SandboxBehavioralAnalysisArgs:
    def __init__(__self__, *,
                 file_hashes_to_be_blockeds: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
        The set of arguments for constructing a SandboxBehavioralAnalysis resource.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] file_hashes_to_be_blockeds: A custom list of unique MD5 file hashes that must be blocked by Sandbox. A maximum of 10000 MD5 file hashes can be blocked
        """
    ...
    def file_hashes_to_be_blockeds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def file_hashes_to_be_blockeds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class SandboxBehavioralAnalysis(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            file_hashes_to_be_blockeds: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'SandboxBehavioralAnalysis':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="fileHashesToBeBlockeds")
    def file_hashes_to_be_blockeds(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        A custom list of unique MD5 file hashes that must be blocked by Sandbox. A maximum of 10000 MD5 file hashes can be blocked
        """
        return pulumi.get(self, "file_hashes_to_be_blockeds")
