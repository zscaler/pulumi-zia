...
class ForwardingControlZPAGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: (string) - Additional details about the ZPA gateway
        :param pulumi.Input[_builtins.str] name: The name of the forwarding control ZPA Gateway to be exported.
        :param pulumi.Input[_builtins.str] type: (string) - Indicates whether the ZPA gateway is configured for Zscaler Internet Access (using option ZPA) or Zscaler Cloud Connector (using option ECZPA). Supported values: ``ZPA`` and ``ECZPA``
...
class ForwardingControlZPAGateway(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="zpaAppSegments")
    def zpa_app_segments(self) -> pulumi.Output[Optional[Sequence['outputs.ForwardingControlZPAGatewayZpaAppSegment']]]:
        """
        The ZPA Server Group that is configured for Source IP Anchoring
        """
        return pulumi.get(self, "zpa_app_segments")
