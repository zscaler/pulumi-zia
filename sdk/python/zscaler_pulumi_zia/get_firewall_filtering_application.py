...
class GetFirewallFilteringApplicationResult:
    ...
    def parent_category(self) -> _builtins.str:
        """
        (String)
        """
...
def get_firewall_filtering_application(id: Optional[_builtins.str] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/firewall-policies#/networkApplications-get)
    ...
    :param _builtins.str id: The name of the ip source group to be exported.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_firewall_filtering_application_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
