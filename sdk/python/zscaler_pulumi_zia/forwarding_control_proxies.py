...
class ForwardingControlProxiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] address: The IP address or the FQDN of the third-party proxy service
        :param pulumi.Input[_builtins.bool] base64_encode_xau_header: (Boolean) Flag indicating whether the added X-Authenticated-User header is Base64 encoded. When enabled, the user ID is encoded using the Base64 encoding method.
        ...
        :param pulumi.Input[_builtins.str] description: (String) Additional notes or information
        :param pulumi.Input[_builtins.bool] insert_xau_header: (Boolean) Flag indicating whether X-Authenticated-User header is added by the proxy. Enable to automatically insert authenticated user ID to the HTTP header, X-Authenticated-User.
        :param pulumi.Input[_builtins.str] name: Proxy name for the third-party proxy services
        :param pulumi.Input[_builtins.int] port: The port number on which the third-party proxy service listens to the requests forwarded from Zscaler
        :param pulumi.Input[_builtins.str] type: Gateway type. Supported values: `PROXYCHAIN`, `ZIA`, `ECSELF`
        """
...
class ForwardingControlProxies(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            port: Optional[pulumi.Input[_builtins.int]] = None,
            proxy_id: Optional[pulumi.Input[_builtins.int]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None) -> 'ForwardingControlProxies':
        """
