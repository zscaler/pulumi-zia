...
def get_firewall_filtering_source_ip_groups(id: Optional[_builtins.int] = None,
...
def get_firewall_filtering_source_ip_groups_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
