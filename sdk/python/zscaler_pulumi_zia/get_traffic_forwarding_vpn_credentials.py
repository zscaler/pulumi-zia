...
def get_traffic_forwarding_vpn_credentials(fqdn: Optional[_builtins.str] = None,
    ...
    * Extended Authentication (XAUTH) or hosted mobile UserID - requires VPN_MOBILE subscription
    ...
    :param _builtins.str ip_address: Filter based on an IP address range.
...
def get_traffic_forwarding_vpn_credentials_output(fqdn: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
