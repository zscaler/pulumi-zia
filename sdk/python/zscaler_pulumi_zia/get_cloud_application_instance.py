...
def get_cloud_application_instance(id: Optional[_builtins.int] = None,
...
def get_cloud_application_instance_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
