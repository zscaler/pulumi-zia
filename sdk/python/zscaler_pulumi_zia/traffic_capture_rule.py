...
__all__ = ['TrafficCaptureRuleArgs', 'TrafficCaptureRule']

@pulumi.input_type
class TrafficCaptureRuleArgs:
...
@pulumi.type_token("zia:index:TrafficCaptureRule")
class TrafficCaptureRule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TrafficCaptureRuleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TrafficCaptureRuleArgs.__new__(TrafficCaptureRuleArgs)
        ...
        super(TrafficCaptureRule, __self__).__init__(
            'zia:index:TrafficCaptureRule',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'TrafficCaptureRule':
        """
        ...
        __props__.__dict__["txn_sampling"] = None
        __props__.__dict__["txn_size_limit"] = None
        __props__.__dict__["users"] = None
        __props__.__dict__["workload_groups"] = None
        return TrafficCaptureRule(resource_name, opts=opts, __props__=__props__)
