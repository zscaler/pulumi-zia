...
class SandboxRulesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] file_types: (List of Strings) File type categories for which the policy is applied. If not set, the rule is applied across all file types.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] protocols: Protocol for the given rule. This field is not applicable to the Lite API.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ba_policy_categories: The threat categories to which the rule applies
        :param pulumi.Input[_builtins.str] ba_rule_action: (String) The action configured for the rule that must take place if the traffic matches the rule criteria. Supported Values: `ALLOW` or `BLOCK`
        :param pulumi.Input[_builtins.int] by_threat_score: (Integer)
        ...
        :param pulumi.Input[_builtins.bool] first_time_enable: (Boolean) A Boolean value indicating whether a First-Time Action is specifically configured for the rule. The First-Time Action takes place when users download unknown files. The action to be applied is specified using the firstTimeOperation field.
        :param pulumi.Input[_builtins.str] first_time_operation: (String) The action that must take place when users download unknown files for the first time. Supported Values: `ALLOW_SCAN`, `QUARANTINE`, `ALLOW_NOSCAN`, `QUARANTINE_ISOLATE`
        ...
        :param pulumi.Input[_builtins.bool] ml_action_enabled: (Boolean) A Boolean value indicating whether to enable or disable the AI Instant Verdict option to have the Zscaler service use AI analysis to instantly assign threat scores to unknown files. This option is available to use only with specific rule actions such as Quarantine and Allow and Scan for First-Time Action.
        :param pulumi.Input[_builtins.str] name: The File Type Control policy rule name.
        :param pulumi.Input[_builtins.int] rank: (Integer) The admin rank specified for the rule based on your assigned admin rank. Admin rank determines the rule order that can be specified for the rule. Admin rank can be configured if it is enabled in the Advanced Settings.
        :param pulumi.Input[_builtins.str] state: (String) The state of the rule indicating whether it is enabled or disabled. Supported values: `ENABLED` or `DISABLED`
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] url_categories: (List of Strings) The list of URL categories to which the Sandbox rule must be applied. See the [URL Categories API](https://help.zscaler.com/zia/url-categories#/urlCategories-get) for the list of available categories or use the data source `URLCategories` to retrieve the list of URL categories.
...
class SandboxRules(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="baRuleAction")
    def ba_rule_action(self) -> pulumi.Output[_builtins.str]:
        """
        (String) The action configured for the rule that must take place if the traffic matches the rule criteria. Supported Values: `ALLOW` or `BLOCK`
        """
        return pulumi.get(self, "ba_rule_action")
    ...
    @_builtins.property
    @pulumi.getter(name="byThreatScore")
    def by_threat_score(self) -> pulumi.Output[_builtins.int]:
        """
        (Integer)
        """
        return pulumi.get(self, "by_threat_score")
    ...
    @_builtins.property
    @pulumi.getter(name="firstTimeEnable")
    def first_time_enable(self) -> pulumi.Output[_builtins.bool]:
        """
        (Boolean) A Boolean value indicating whether a First-Time Action is specifically configured for the rule. The First-Time Action takes place when users download unknown files. The action to be applied is specified using the firstTimeOperation field.
        """
        return pulumi.get(self, "first_time_enable")
    ...
    @_builtins.property
    @pulumi.getter(name="firstTimeOperation")
    def first_time_operation(self) -> pulumi.Output[_builtins.str]:
        """
        (String) The action that must take place when users download unknown files for the first time. Supported Values: `ALLOW_SCAN`, `QUARANTINE`, `ALLOW_NOSCAN`, `QUARANTINE_ISOLATE`
        """
        return pulumi.get(self, "first_time_operation")
    ...
    @_builtins.property
    @pulumi.getter(name="mlActionEnabled")
    def ml_action_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        (Boolean) A Boolean value indicating whether to enable or disable the AI Instant Verdict option to have the Zscaler service use AI analysis to instantly assign threat scores to unknown files. This option is available to use only with specific rule actions such as Quarantine and Allow and Scan for First-Time Action.
        """
        return pulumi.get(self, "ml_action_enabled")
