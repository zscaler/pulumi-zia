...
def get_cbi_profile(id: Optional[_builtins.str] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/browser-isolation#/browserIsolation/profiles-get)
    ...
    :param _builtins.str id: (string) The universally unique identifier (UUID) for the browser isolation profile.
    :param _builtins.str name: This field defines the name of the isolation profile.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_cbi_profile_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
