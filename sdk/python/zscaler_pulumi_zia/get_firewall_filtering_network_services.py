...
class GetFirewallFilteringNetworkServicesResult:
    ...
    """
    def __init__(__self__, description=None, dest_tcp_ports=None, dest_udp_ports=None, id=None, is_name_l10n_tag=None, locale=None, name=None, protocol=None, src_tcp_ports=None, src_udp_ports=None, tag=None, type=None):
...
def get_firewall_filtering_network_services(id: Optional[_builtins.int] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/firewall-policies#/networkServices-get)
    ...
    :param _builtins.int id: The ID of the application layer service to be exported.
    :param _builtins.str locale: (String) When set to one of the supported locales (i.e., `en-US`, `de-DE`, `es-ES`, `fr-FR`, `ja-JP`,`fr-FR`, `ja-JP`, `zh-CN`), the network service's description is localized into the requested language.
    :param _builtins.str name: Name of the application layer service that you want to control. It can include any character and spaces.
    ...
    :param _builtins.str protocol: (String) Filter based on the network service protocol. Supported values are: `TCP`, `UDP`, `ICMP`, `GRE`, `ESP`, `OTHER`
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_firewall_filtering_network_services_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
