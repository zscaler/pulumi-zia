...
def get_sandbox_report(details: Optional[_builtins.str] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/sandbox-report#/sandbox/report/{md5Hash}-get)
    ...
    :param _builtins.str details: (Required) Type of report, full or summary.
    :param _builtins.str md5_hash: (Required) MD5 hash of the file that was analyzed by Sandbox.
    """
    __args__ = dict()
