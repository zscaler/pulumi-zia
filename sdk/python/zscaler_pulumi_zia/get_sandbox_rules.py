...
class GetSandboxRulesResult:
    ...
    def first_time_enable(self) -> _builtins.bool:
        return pulumi.get(self, "first_time_enable")

    @_builtins.property
    @pulumi.getter(name="firstTimeOperation")
    def first_time_operation(self) -> _builtins.str:
    ...
    def ml_action_enabled(self) -> _builtins.bool:
...
def get_sandbox_rules(id: Optional[_builtins.int] = None,
...
def get_sandbox_rules_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
