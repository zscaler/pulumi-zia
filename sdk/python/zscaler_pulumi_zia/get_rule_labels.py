...
class GetRuleLabelsResult:
    ...
    def referenced_rule_count(self) -> _builtins.int:
        """
...
def get_rule_labels(id: Optional[_builtins.int] = None,
...
def get_rule_labels_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
