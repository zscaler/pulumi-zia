...
__all__ = [
    'GetIPSFirewallRuleResult',
    'AwaitableGetIPSFirewallRuleResult',
    'get_ips_firewall_rule',
    'get_ips_firewall_rule_output',
]

@pulumi.output_type
class GetIPSFirewallRuleResult:
    """
    A collection of values returned by getIPSFirewallRule.
    """
    def __init__(__self__, action=None, capture_pcap=None, default_rule=None, departments=None, description=None, dest_addresses=None, dest_countries=None, dest_ip_categories=None, dest_ip_groups=None, dest_ipv6_groups=None, device_groups=None, devices=None, enable_full_logging=None, eun_template_id=None, groups=None, id=None, is_eun_enabled=None, labels=None, last_modified_bies=None, last_modified_time=None, location_groups=None, locations=None, name=None, nw_service_groups=None, nw_services=None, order=None, predefined=None, rank=None, res_categories=None, source_countries=None, src_ip_groups=None, src_ips=None, src_ipv6_groups=None, state=None, threat_categories=None, time_windows=None, users=None, zpa_app_segments=None):
        ...
        if is_eun_enabled and not isinstance(is_eun_enabled, bool):
            raise TypeError("Expected argument 'is_eun_enabled' to be a bool")
    ...
    def capture_pcap(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def departments(self) -> Sequence['outputs.GetIPSFirewallRuleDepartmentResult']:
        """
    ...
    def dest_ip_groups(self) -> Sequence['outputs.GetIPSFirewallRuleDestIpGroupResult']:
        """
    ...
    def dest_ipv6_groups(self) -> Sequence['outputs.GetIPSFirewallRuleDestIpv6GroupResult']:
        return pulumi.get(self, "dest_ipv6_groups")

    @_builtins.property
    @pulumi.getter(name="deviceGroups")
    def device_groups(self) -> Sequence['outputs.GetIPSFirewallRuleDeviceGroupResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def devices(self) -> Sequence['outputs.GetIPSFirewallRuleDeviceResult']:
        """
    ...
    def enable_full_logging(self) -> _builtins.bool:
        """
    ...
    def eun_template_id(self) -> Optional[_builtins.int]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def groups(self) -> Sequence['outputs.GetIPSFirewallRuleGroupResult']:
        """
    ...
    def is_eun_enabled(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "is_eun_enabled")

    @_builtins.property
    @pulumi.getter
    def labels(self) -> Sequence['outputs.GetIPSFirewallRuleLabelResult']:
        """
    ...
    def last_modified_bies(self) -> Sequence['outputs.GetIPSFirewallRuleLastModifiedByResult']:
    ...
    def location_groups(self) -> Sequence['outputs.GetIPSFirewallRuleLocationGroupResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def locations(self) -> Sequence['outputs.GetIPSFirewallRuleLocationResult']:
        """
    ...
    def nw_service_groups(self) -> Sequence['outputs.GetIPSFirewallRuleNwServiceGroupResult']:
        """
    ...
    def nw_services(self) -> Sequence['outputs.GetIPSFirewallRuleNwServiceResult']:
        """
    ...
    def res_categories(self) -> Sequence[_builtins.str]:
        """
    ...
    def src_ip_groups(self) -> Sequence['outputs.GetIPSFirewallRuleSrcIpGroupResult']:
        """
    ...
    def src_ipv6_groups(self) -> Sequence['outputs.GetIPSFirewallRuleSrcIpv6GroupResult']:
        """
    ...
    def threat_categories(self) -> Sequence['outputs.GetIPSFirewallRuleThreatCategoryResult']:
        """
    ...
    def time_windows(self) -> Sequence['outputs.GetIPSFirewallRuleTimeWindowResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def users(self) -> Sequence['outputs.GetIPSFirewallRuleUserResult']:
        """
    ...
    def zpa_app_segments(self) -> Sequence['outputs.GetIPSFirewallRuleZpaAppSegmentResult']:
        """
...
class AwaitableGetIPSFirewallRuleResult(GetIPSFirewallRuleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIPSFirewallRuleResult(
            action=self.action,
            ...
            groups=self.groups,
            id=self.id,
            is_eun_enabled=self.is_eun_enabled,
            labels=self.labels,
...
def get_ips_firewall_rule(eun_template_id: Optional[_builtins.int] = None,
                          id: Optional[_builtins.int] = None,
                          is_eun_enabled: Optional[_builtins.bool] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/configuring-ips-control-policy)
    ...
    :param _builtins.int eun_template_id: (Integer) The EUN template ID associated with the rule
    ...
    """
    __args__ = dict()
    __args__['eunTemplateId'] = eun_template_id
    __args__['id'] = id
    __args__['isEunEnabled'] = is_eun_enabled
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('zia:index/getIPSFirewallRule:getIPSFirewallRule', __args__, opts=opts, typ=GetIPSFirewallRuleResult).value

    return AwaitableGetIPSFirewallRuleResult(
        ...
        is_eun_enabled=pulumi.get(__ret__, 'is_eun_enabled'),
...
def get_ips_firewall_rule_output(eun_template_id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                 id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                 is_eun_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/configuring-ips-control-policy)
    ...
    __ret__ = pulumi.runtime.invoke_output('zia:index/getIPSFirewallRule:getIPSFirewallRule', __args__, opts=opts, typ=GetIPSFirewallRuleResult)
    return __ret__.apply(lambda __response__: GetIPSFirewallRuleResult(
        ...
        is_eun_enabled=pulumi.get(__response__, 'is_eun_enabled'),
