...
class ActivationStatusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] status: Organization Policy Edit/Update Activation status
        """
...
class ActivationStatus(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None) -> 'ActivationStatus':
        """
