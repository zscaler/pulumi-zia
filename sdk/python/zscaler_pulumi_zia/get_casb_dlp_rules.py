...
class GetCasbDlpRulesResult:
    ...
    def collaboration_scopes(self) -> Sequence[_builtins.str]:
        """
    ...
    def include_criteria_domain_profile(self) -> _builtins.bool:
        """
    ...
    def include_email_recipient_profile(self) -> _builtins.bool:
        """
    ...
    def include_entity_groups(self) -> _builtins.bool:
        """
    ...
    def number_of_external_collaborators(self) -> _builtins.str:
        """
    ...
    def number_of_internal_collaborators(self) -> _builtins.str:
        """
    ...
    def quarantine_location(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def receivers(self) -> Sequence['outputs.GetCasbDlpRulesReceiverResult']:
    ...
    def watermark_delete_old_version(self) -> _builtins.bool:
        """
...
def get_casb_dlp_rules(id: Optional[_builtins.int] = None,
...
def get_casb_dlp_rules_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
