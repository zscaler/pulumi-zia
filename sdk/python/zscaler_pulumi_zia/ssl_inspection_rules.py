...
class SSLInspectionRulesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] order: (String) -  Policy rules are evaluated in ascending numerical order (Rule 1 before Rule 2, and so on), and the Rule Order reflects this rule's place in the order.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] cloud_applications: (List of Strings) The list of cloud applications to which the File Type Control policy rule must be applied. To retrieve the list of cloud applications, use the data source: `get_cloud_applications`. For the complete list of supported file types refer to the  [ZIA API documentation](https://help.zscaler.com/zia/data-loss-prevention#/webDlpRules-post). To retrieve the list of cloud applications, use the data source: `get_cloud_applications`
        ...
        :param pulumi.Input[_builtins.str] name: The name of the SSL Inspection rule
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] platforms: (Set of String) -  Zscaler Client Connector device platforms for which this rule is applied. Supported Values: `SCAN_IOS`, `SCAN_ANDROID`, `SCAN_MACOS`, `SCAN_WINDOWS`, `NO_CLIENT_CONNECTOR`, `SCAN_LINUX`
        ...
        :param pulumi.Input[_builtins.bool] road_warrior_for_kerberos: (Boolean) - Indicates whether this rule is applied to remote users that use PAC with Kerberos authentication.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] url_categories: (List of Strings) The list of URL categories to which the SSL Inspection rule must be applied. See the [URL Categories API](https://help.zscaler.com/zia/url-categories#/urlCategories-get) for the list of available categories or use the data source `URLCategories` to retrieve the list of URL categories.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] user_agent_types: (Set of String) -  A list of user agent types the rule applies to.
