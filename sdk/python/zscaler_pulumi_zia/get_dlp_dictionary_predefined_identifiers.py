...
def get_dlp_dictionary_predefined_identifiers(id: Optional[_builtins.str] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/data-loss-prevention#/dlpDictionaries/{dictId}/predefinedIdentifiers-get)
    ...
    :param _builtins.str id: (String) The ID of the hierarchical DLP dictionary.
    :param _builtins.str name: The name of the hierarchical DLP dictionary.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_dlp_dictionary_predefined_identifiers_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
