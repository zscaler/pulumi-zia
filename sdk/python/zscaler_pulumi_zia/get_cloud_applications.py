...
class GetCloudApplicationsResult:
    ...
    def app_classes(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_cloud_applications(app_classes: Optional[Sequence[_builtins.str]] = None,
    ...
    **Note**: Refer to this matrix when configuring types vs actions for each specific rules
    ...
    :param Sequence[_builtins.str] app_classes: (Set of Strings) Filter application by application category
...
def get_cloud_applications_output(app_classes: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
