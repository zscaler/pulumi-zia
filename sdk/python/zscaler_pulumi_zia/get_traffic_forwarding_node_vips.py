...
class GetTrafficForwardingNodeVIPsResult:
    ...
    def gre_domain_name(self) -> _builtins.str:
        return pulumi.get(self, "gre_domain_name")

    @_builtins.property
    @pulumi.getter(name="greIps")
    def gre_ips(self) -> Sequence[_builtins.str]:
    ...
    def pac_domain_name(self) -> _builtins.str:
        return pulumi.get(self, "pac_domain_name")

    @_builtins.property
    @pulumi.getter(name="pacIps")
    def pac_ips(self) -> Sequence[_builtins.str]:
    ...
    def vpn_domain_name(self) -> _builtins.str:
        return pulumi.get(self, "vpn_domain_name")

    @_builtins.property
    @pulumi.getter(name="vpnIps")
    def vpn_ips(self) -> Sequence[_builtins.str]:
...
def get_traffic_forwarding_node_vips(datacenter: Optional[_builtins.str] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/traffic-forwarding-0#/greTunnels-post)
    ...
    :param _builtins.str datacenter: Data-center Name
    """
    __args__ = dict()
...
def get_traffic_forwarding_node_vips_output(datacenter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
