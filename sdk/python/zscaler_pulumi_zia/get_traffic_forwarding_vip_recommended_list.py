...
class GetTrafficForwardingVIPRecommendedListResult:
    ...
    def include_current_vips(self) -> Optional[_builtins.bool]:
        """
    ...
    def include_private_service_edge(self) -> Optional[_builtins.bool]:
        """
    ...
    def required_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "required_count")

    @_builtins.property
    @pulumi.getter(name="routableIp")
    def routable_ip(self) -> Optional[_builtins.bool]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def subcloud(self) -> Optional[_builtins.str]:
        """
    ...
    def within_country_only(self) -> Optional[_builtins.bool]:
        """
...
def get_traffic_forwarding_vip_recommended_list(include_current_vips: Optional[_builtins.bool] = None,
                                                include_private_service_edge: Optional[_builtins.bool] = None,
                                                latitude: Optional[_builtins.float] = None,
                                                longitude: Optional[_builtins.float] = None,
                                                required_count: Optional[_builtins.int] = None,
                                                routable_ip: Optional[_builtins.bool] = None,
                                                source_ip: Optional[_builtins.str] = None,
                                                subcloud: Optional[_builtins.str] = None,
                                                within_country_only: Optional[_builtins.bool] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/traffic-forwarding-0#/greTunnels-post)
    ...
    :param _builtins.bool include_current_vips: (Boolean) Include currently assigned VIPs.
    :param _builtins.bool include_private_service_edge: (Boolean) Include ZIA Private Service Edge VIPs.
    ...
    :param _builtins.int required_count: Number of IP address to be exported.
    :param _builtins.bool routable_ip: (Boolean) The routable IP address.
    :param _builtins.str source_ip: Filter based on an IP address range.
    :param _builtins.str subcloud: (String) The longitude coordinate of the GRE tunnel source.
    :param _builtins.bool within_country_only: (Boolean) Search within country only.
    """
    __args__ = dict()
...
def get_traffic_forwarding_vip_recommended_list_output(include_current_vips: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                                       include_private_service_edge: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                                       latitude: Optional[pulumi.Input[Optional[_builtins.float]]] = None,
                                                       longitude: Optional[pulumi.Input[Optional[_builtins.float]]] = None,
                                                       required_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                                       routable_ip: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                                       source_ip: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                       subcloud: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                       within_country_only: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
