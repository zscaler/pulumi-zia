...
def get_virtual_service_edge_cluster(id: Optional[_builtins.int] = None,
...
def get_virtual_service_edge_cluster_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
