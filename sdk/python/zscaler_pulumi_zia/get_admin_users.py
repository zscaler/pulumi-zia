...
class GetAdminUsersResult:
    ...
    def is_exec_mobile_app_enabled(self) -> _builtins.bool:
        """
    ...
    def is_password_login_allowed(self) -> _builtins.bool:
        """
    ...
    def is_product_update_comm_enabled(self) -> _builtins.bool:
        """
    ...
    def is_security_report_comm_enabled(self) -> _builtins.bool:
        """
    ...
    def is_service_update_comm_enabled(self) -> _builtins.bool:
        """
    ...
    def pwd_last_modified_time(self) -> _builtins.int:
...
def get_admin_users(id: Optional[_builtins.int] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/admin-role-management#/adminUsers-get)
    ...
    :param _builtins.str login_name: The email address of the admin user to be exported.
    :param _builtins.str username: The username of the admin user to be exported.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_admin_users_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
