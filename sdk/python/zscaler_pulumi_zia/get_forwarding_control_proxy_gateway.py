...
def get_forwarding_control_proxy_gateway(id: Optional[_builtins.int] = None,
...
def get_forwarding_control_proxy_gateway_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
