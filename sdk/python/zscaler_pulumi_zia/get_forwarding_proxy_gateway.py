...
__all__ = [
    'GetForwardingProxyGatewayResult',
    'AwaitableGetForwardingProxyGatewayResult',
    'get_forwarding_proxy_gateway',
    'get_forwarding_proxy_gateway_output',
]

@pulumi.output_type
class GetForwardingProxyGatewayResult:
    """
    ...
    def last_modified_bies(self) -> Sequence['outputs.GetForwardingProxyGatewayLastModifiedByResult']:
        """
    ...
    def primary_proxies(self) -> Sequence['outputs.GetForwardingProxyGatewayPrimaryProxyResult']:
        """
    ...
    def secondary_proxies(self) -> Sequence['outputs.GetForwardingProxyGatewaySecondaryProxyResult']:
        """
...
class AwaitableGetForwardingProxyGatewayResult(GetForwardingProxyGatewayResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetForwardingProxyGatewayResult(
...
def get_forwarding_proxy_gateway(id: Optional[_builtins.int] = None,
                                 name: Optional[_builtins.str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetForwardingProxyGatewayResult:
    """
    ...
    * [API documentation](https://help.zscaler.com/zia/forwarding-control-policy#/proxyGateways-get)
    ...
    __ret__ = pulumi.runtime.invoke('zia:index/getForwardingProxyGateway:getForwardingProxyGateway', __args__, opts=opts, typ=GetForwardingProxyGatewayResult).value

    return AwaitableGetForwardingProxyGatewayResult(
...
def get_forwarding_proxy_gateway_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                        name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetForwardingProxyGatewayResult]:
    """
    * [Official documentation](https://help.zscaler.com/zia/about-gateways-proxies)
    * [API documentation](https://help.zscaler.com/zia/forwarding-control-policy#/proxyGateways-get)
    ...
    __ret__ = pulumi.runtime.invoke_output('zia:index/getForwardingProxyGateway:getForwardingProxyGateway', __args__, opts=opts, typ=GetForwardingProxyGatewayResult)
    return __ret__.apply(lambda __response__: GetForwardingProxyGatewayResult(
