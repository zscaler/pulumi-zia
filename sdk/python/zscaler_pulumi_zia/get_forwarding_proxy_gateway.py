...
def get_forwarding_proxy_gateway(id: Optional[builtins.int] = None,
...
def get_forwarding_proxy_gateway_output(id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
