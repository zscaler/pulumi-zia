...
class GetTrafficForwardingGRETunnelResult:
    ...
    def internal_ip_range(self) -> _builtins.str:
        """
    ...
    def last_modification_time(self) -> _builtins.int:
    ...
    def within_country(self) -> _builtins.bool:
        """
...
def get_traffic_forwarding_gre_tunnel(id: Optional[_builtins.int] = None,
    ...
    * [API documentation](https://help.zscaler.com/zia/traffic-forwarding-0#/greTunnels-post)
    ...
    :param _builtins.str source_ip: The source IP address of the GRE tunnel. This is typically a static IP address in the organization or SD-WAN.
...
def get_traffic_forwarding_gre_tunnel_output(id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
